...
public class UserTableDataBuilder extends AbstractDataBuilder {
    protected static final Log log = LogFactory.getLog(UserTableDataBuilder.class);
    ...
    public void execute() {
        ...
        header.append("INSERT INTO RP_USER (");
