...
public class ContentTableDataBuilder extends AbstractDataBuilder {
    protected static final Log log = LogFactory.getLog(ContentTableDataBuilder.class);
    ...
    public void execute() {
        ...
        header.append("INSERT INTO CONTENT (");
