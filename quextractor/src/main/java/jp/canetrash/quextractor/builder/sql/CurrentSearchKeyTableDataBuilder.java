...
public class CurrentSearchKeyTableDataBuilder extends AbstractDataBuilder {
    protected static final Log log = LogFactory.getLog(CurrentSearchKeyTableDataBuilder.class);

    public void execute() {
        StringBuffer header = new StringBuffer();
        header.append("INSERT INTO CURRENT_SEARCHKEY (");
