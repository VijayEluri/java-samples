...
public class UserSearchkeyTableDataBuilder extends AbstractDataBuilder {
    protected static final Log log = LogFactory.getLog(UserSearchkeyTableDataBuilder.class);
    ...
    public void execute() {
        ...
        header.append("INSERT INTO USER_SEARCHKEY (");
