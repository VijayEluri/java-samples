 ...
 */
public class Sample2FetchNarrowingResultSetWrapper extends ResultSetWrapper {
    ...
    protected Sample2FetchNarrowingBean _fetchNarrowingBean;
     ...
     */
    public Sample2FetchNarrowingResultSetWrapper(ResultSet resultSet, Sample2FetchNarrowingBean fetchNarrowingBean
    ...
    protected void checkSafetyResult(boolean hasNext) {
        if (hasNext && getSafetyMaxResultSize() > 0 && _requestCounter > (getSafetyMaxResultSize() + 1)) {
            ...
            throw new jp.co.np.p2netex.sample2.allcommon.exception.Sample2DangerousResultSizeException(msg, getSafetyMaxResultSize());
        }
    }
