package jp.co.np.p2netex.sample1.allcommon.cbean.pagenavi.group;

import java.util.List;
import java.util.ArrayList;
import java.util.Iterator;

import jp.co.np.p2netex.sample1.allcommon.cbean.pagenavi.Sample1PageNumberLink;
import jp.co.np.p2netex.sample1.allcommon.cbean.pagenavi.Sample1PageNumberLinkSetupper;

/**
 * The bean of page group.
 * @author DBFlute(AutoGenerator)
 */
public class Sample1PageGroupBean implements java.io.Serializable {
     ...
     */
    public <LINK extends Sample1PageNumberLink> List<LINK> buildPageNumberLinkList(Sample1PageNumberLinkSetupper<LINK> pageNumberLinkSetupper) {
