 ...
 */
public class Sample2AccessContext {

    // ===================================================================================
    //                                                                        Thread Local
    //                                                                        ============
    /** The thread-local for this. */
    private static final ThreadLocal<Sample2AccessContext> threadLocal = new ThreadLocal<Sample2AccessContext>();

    /**
     * Get access-context on thread.
     * @return Access-context. (Nullable)
     */
    public static Sample2AccessContext getAccessContextOnThread() {
        return (Sample2AccessContext) threadLocal.get();
    }
     ...
     */
    public static void setAccessContextOnThread(Sample2AccessContext accessContext) {
    ...
    public static String getAccessUserOnThread() {
        if (isExistAccessContextOnThread()) {
            final Sample2AccessContext userContextOnThread = getAccessContextOnThread();
