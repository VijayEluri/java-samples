...
public abstract class Sample2AbstractSqlClause implements Sample2SqlClause {
    ...
    /** Order-by clause. */
    protected final Sample2OrderByClause _orderByClause = new Sample2OrderByClause();
    ...
    protected List<Sample2WhereClauseSimpleFilter> _whereClauseSimpleFilterList;
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample2AbstractSqlClause(String tableName) {
        if (tableName == null) {
    ...
    public String getSelectClause() {
        StringBuilder sb = new StringBuilder();
        Sample2DBMeta dbmeta = Sample2DBMetaInstanceHandler.findDBMeta(_tableName);
        List<Sample2ColumnInfo> columnInfoList = dbmeta.getColumnInfoList();
    ...
    public String getSelectClausePKOnly() {
        StringBuilder sb = new StringBuilder();
        Sample2DBMeta dbmeta = Sample2DBMetaInstanceHandler.findDBMeta(_tableName);
        Sample2UniqueInfo uniqueInfo = dbmeta.getPrimaryUniqueInfo();
        List<Sample2ColumnInfo> columnInfoList = uniqueInfo.getUniqueColumnList();
        for (Sample2ColumnInfo columnInfo : columnInfoList) {
            String columnName = columnInfo.getColumnDbName();
            if (sb.length() > 0) {
                sb.append(", ");
    ...
    //                                                                          Copy Parts
    //                                                                          ==========
    public void copyIncludedSelectColumn(Sample2SqlClause sqlClause) {
    ...
    protected Map<String, SelectedSelectColumnInfo> createSelectedSelectColumnInfo(String foreignTableAliasName
                                                                                 ...
                                                                                 , String foreignPropertyName
                                                                                 , String localRelationPath) {
        final Sample2DBMeta dbmeta = Sample2DBMetaInstanceHandler.findDBMeta(localTableName);
        final Sample2ForeignInfo foreignInfo = dbmeta.findForeignInfo(foreignPropertyName);
        ...
        final Sample2DBMeta foreignDBMeta = foreignInfo.getForeignDBMeta();
        final List<Sample2ColumnInfo> columnInfoList = foreignDBMeta.getColumnInfoList();
        for (Sample2ColumnInfo columnInfo : columnInfoList) {
    ...
    //                                                                               Where
    //                                                                               =====
    public void registerWhereClause(String columnFullName, Sample2ConditionKey key, Sample2ConditionValue value) {
    ...
    public void registerWhereClause(String columnFullName, Sample2ConditionKey key, Sample2ConditionValue value, Sample2ConditionOption option) {
        assertStringNotNullAndNotTrimmedEmpty("columnFullName", columnFullName);
    ...
    //                                                                         InlineWhere
    //                                                                         ===========
    public void registerBaseTableInlineWhereClause(String columnName, Sample2ConditionKey key, Sample2ConditionValue value) {
    ...
    public void registerBaseTableInlineWhereClause(String columnName, Sample2ConditionKey key, Sample2ConditionValue value, Sample2ConditionOption option) {
        assertStringNotNullAndNotTrimmedEmpty("columnName", columnName);
    ...
    public void registerOuterJoinInlineWhereClause(String aliasName, String columnName, Sample2ConditionKey key, Sample2ConditionValue value, boolean onClauseInline) {
    ...
    public void registerOuterJoinInlineWhereClause(String aliasName, String columnName, Sample2ConditionKey key, Sample2ConditionValue value, Sample2ConditionOption option, boolean onClauseInline) {
        assertNotYetOuterJoin(aliasName);
        assertStringNotNullAndNotTrimmedEmpty("columnName", columnName);
        final LeftOuterJoinInfo joinInfo = (LeftOuterJoinInfo)_outerJoinMap.get(aliasName);
        if (onClauseInline) {
    ...
    public Sample2SqlClause clearOrderBy() {
        _isOrderByEffective = false;
        _orderByClause.clear();
        return this;
    }

    public Sample2SqlClause ignoreOrderBy() {
        _isOrderByEffective = false;
        return this;
    }

    public Sample2SqlClause makeOrderByEffective() {
    ...
    public void registerOrderBy(String orderByProperty, String registeredOrderByProperty, boolean ascOrDesc) {
        try {
            ...
            for (final Iterator<String> ite = orderByList.iterator(); ite.hasNext(); ) {
                ...
                Sample2OrderByElement element = new Sample2OrderByElement();
    ...
    protected Sample2OrderByClause.OrderByNullsSetupper createOrderByNullsSetupper() {// As Default
        return new Sample2OrderByClause.OrderByNullsSetupper() {
    ...
    protected Sample2OrderByClause.OrderByNullsSetupper createOrderByNullsSetupperByCaseWhen() {// Helper For Nulls Unsupported Database
        return new Sample2OrderByClause.OrderByNullsSetupper() {
            public String setup(String columnName, String orderByElementClause, boolean nullsFirst) {
     ...
     * @return this. (NotNull)
     */
    public Sample2SqlClause fetchFirst(int fetchSize) {
     ...
     * @return this. (NotNull)
     */
    public Sample2SqlClause fetchScope(int fetchStartIndex, int fetchSize) {
        _isFetchScopeEffective = true;
     ...
     * @return this. (NotNull)
     */
    public Sample2SqlClause fetchPage(int fetchPageNumber) {
        _isFetchScopeEffective = true;
    ...
    public Sample2SqlClause ignoreFetchScope() {
        _isFetchScopeEffective = false;
        doClearFetchPageClause();
        return this;
    }

    public Sample2SqlClause makeFetchScopeEffective() {
    ...
    //                                                            ==========================
    public void addWhereClauseSimpleFilter(Sample2WhereClauseSimpleFilter whereClauseSimpleFilter) {
        if (_whereClauseSimpleFilterList == null) {
            _whereClauseSimpleFilterList = new ArrayList<Sample2WhereClauseSimpleFilter>();
        }
    ...
    protected String filterWhereClauseSimply(String clauseElement) {
        ...
        for (final Iterator<Sample2WhereClauseSimpleFilter> ite = _whereClauseSimpleFilterList.iterator(); ite.hasNext(); ) {
            final Sample2WhereClauseSimpleFilter filter = ite.next();
            if (filter == null) {
    ...
    public String getClauseQueryUpdate(Map<String, String> columnParameterMap) {
        ...
        final Sample2DBMeta dbmeta = findDBMeta();
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected Sample2DBMeta findDBMeta() {
        return Sample2DBMetaInstanceHandler.findDBMeta(_tableName); 
    }
