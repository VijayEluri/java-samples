...
import jp.co.np.p2netex.sample1.allcommon.helper.Sample1MapListString;
import jp.co.np.p2netex.sample1.allcommon.helper.Sample1MapListStringImpl;
...
import jp.co.np.p2netex.sample1.allcommon.dbmeta.info.Sample1UniqueInfo;
...
public abstract class Sample1AbstractDBMeta implements Sample1DBMeta {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<Sample1ColumnInfo> _columnInfoList;
     ...
     */ 
    public Sample1ColumnInfo findColumnInfo(String columnFlexibleName) {
        ...
        try {
            return (Sample1ColumnInfo)method.invoke(this, new Object[]{});
    ...
    protected Sample1ColumnInfo cci(String columnDbName, String propertyName
                           , Class<?> propertyType, boolean primary
                           , Integer columnSize, Integer columnDecimalDigits) {// createColumnInfo()
        return new Sample1ColumnInfo(this, columnDbName, propertyName, propertyType, primary, columnSize, columnDecimalDigits);
    }

    protected Sample1ColumnInfo cci(String columnDbName, String propertyName
                           , Class<?> propertyType, boolean primary
                           , Integer columnSize, Integer columnDecimalDigits, OptimisticLockType optimisticLockType) {// createColumnInfo()
        return new Sample1ColumnInfo(this, columnDbName, propertyName, propertyType, primary, columnSize, columnDecimalDigits, optimisticLockType);
    }
     ...
     */
    public List<Sample1ColumnInfo> getColumnInfoList() {
        ...
        synchronized (this) {
            ...
            Class<Sample1ColumnInfo> returnType = Sample1ColumnInfo.class;
            Object[] args = new Object[]{};
            try {
                for (Method method : methods) {
                    if (method.getName().startsWith(prefix) && returnType.equals(method.getReturnType())) {
                        _columnInfoList.add((Sample1ColumnInfo)method.invoke(this, args));
                    }
                }
            } catch (Exception e) {
    ...
    //                                                                         Unique Info
    //                                                                         ===========
    protected Sample1UniqueInfo createPrimaryUniqueInfo() {
        Sample1UniqueInfo uniqueInfo = new Sample1UniqueInfo();
        uniqueInfo.setDBMeta(this);
        uniqueInfo.setPrimary(true);
        return uniqueInfo;
    }

    protected Sample1UniqueInfo createPrimaryUniqueInfo(Sample1ColumnInfo uniqueColumnInfo) {
        Sample1UniqueInfo uniqueInfo = new Sample1UniqueInfo();
        uniqueInfo.setDBMeta(this);
        uniqueInfo.setPrimary(true);
     ...
     */ 
    public Sample1RelationInfo findRelationInfo(String relationPropertyName) {
        assertStringNotNullAndNotTrimmedEmpty("relationPropertyName", relationPropertyName);
        return hasForeign(relationPropertyName) ? (Sample1RelationInfo)findForeignInfo(relationPropertyName) : (Sample1RelationInfo)findReferrerInfo(relationPropertyName);
    }
     ...
     */ 
    public Sample1DBMeta findForeignDBMeta(String foreignPropertyName) {
     ...
     */ 
    public jp.co.np.p2netex.sample1.allcommon.dbmeta.info.Sample1ForeignInfo findForeignInfo(String foreignPropertyName) {
        assertStringNotNullAndNotTrimmedEmpty("foreignPropertyName", foreignPropertyName);
        final String methodName = buildRelationInfoGetterMethodNameInitCap("foreign", foreignPropertyName);
        ...
        try {
            return (Sample1ForeignInfo)method.invoke(this, new Object[]{});
        } catch (IllegalAccessException e) {
            throw new RuntimeException(e);
        } catch (java.lang.reflect.InvocationTargetException e) {
            throw new RuntimeException(e.getCause());
    ...
    protected Sample1ForeignInfo cfi(String propName
                            , Sample1DBMeta localDbm, Sample1DBMeta foreignDbm
                            , Map<Sample1ColumnInfo, Sample1ColumnInfo> localForeignColumnInfoMap
                            , int relNo, boolean oneToOne) {// createForeignInfo()
        final Sample1ForeignInfo foreignInfo = new Sample1ForeignInfo();
     ...
     */ 
    public Sample1DBMeta findReferrerDBMeta(String referrerPropertyName) {
        assertStringNotNullAndNotTrimmedEmpty("referrerPropertyName", referrerPropertyName);
     ...
     */ 
    public Sample1ReferrerInfo findReferrerInfo(String referrerPropertyName) {
        assertStringNotNullAndNotTrimmedEmpty("referrerPropertyName", referrerPropertyName);
        final String methodName = buildRelationInfoGetterMethodNameInitCap("referrer", referrerPropertyName);
        java.lang.reflect.Method method = null;
        try {
        ...
        try {
            return (Sample1ReferrerInfo)method.invoke(this, new Object[]{});
        } catch (IllegalAccessException e) {
            throw new RuntimeException(e);
        } catch (java.lang.reflect.InvocationTargetException e) {
            throw new RuntimeException(e.getCause());
    ...
    protected Sample1ReferrerInfo cri(String propName
                             , Sample1DBMeta localDbm, Sample1DBMeta referrerDbm
                             , Map<Sample1ColumnInfo, Sample1ColumnInfo> localReferrerColumnInfoMap
                             , boolean oneToOne) {// createReferrerInfo()
        final Sample1ReferrerInfo referrerInfo = new Sample1ReferrerInfo();
    ...
    protected static abstract class AbstractRelationTrace implements RelationTrace {
        ...
        protected List<Sample1RelationInfo> _relationList;

        /** The list of relation trace. */
        protected List<AbstractRelationTrace> _relationTraceList;

        /** The list of relation info as trace. */
        protected List<Sample1RelationInfo> _traceRelationInfoList;

        /** The column info as trace. */
        protected Sample1ColumnInfo _traceColumnInfo;
        ...
        public AbstractRelationTrace(RelationTraceFixHandler relationTraceFixHandler) {
            this(new ArrayList<Sample1RelationInfo>(), new ArrayList<AbstractRelationTrace>());
         ...
         */
        public AbstractRelationTrace(List<Sample1RelationInfo> relationList, List<AbstractRelationTrace> relationTraceList) {
         ...
         */
        public List<Sample1RelationInfo> getTraceRelation() {
         ...
         */
        public Sample1ColumnInfo getTraceColumn() {
         ...
         */
        protected RelationTrace fixTrace(List<Sample1RelationInfo> traceRelationInfoList, Sample1ColumnInfo traceColumnInfo) {
        ...
        protected void setTraceRelation(List<Sample1RelationInfo> traceRelationInfoList) {
            this._traceRelationInfoList = traceRelationInfoList;
        }

        protected void setTraceColumn(Sample1ColumnInfo traceColumn) {
        ...
        protected void recycle() {
            this._relationList = new ArrayList<Sample1RelationInfo>();
     ...
     */
    public Sample1MapListString createMapListString() {
     ...
     */
    public Sample1MapStringBuilder createMapStringBuilder() {
        final List<String> columnDbNameList = new ArrayList<String>();
        for (final Iterator<Sample1ColumnInfo> ite = getColumnInfoList().iterator(); ite.hasNext(); ) {
    ...
    public Sample1ColumnInfo getVersionNoColumnInfo() { return null; }
    public boolean hasUpdateDate() { return false; }
    public Sample1ColumnInfo getUpdateDateColumnInfo() { return null; }
    ...
    //                                                Accept
    //                                                ------
    protected <ENTITY extends Sample1Entity> void doAcceptPrimaryKeyMap(ENTITY entity
        ...
        List<Sample1ColumnInfo> columnInfoList = getPrimaryUniqueInfo().getUniqueColumnList();
        for (Sample1ColumnInfo columnInfo : columnInfoList) {
    ...
    protected <ENTITY extends Sample1Entity> void doAcceptColumnValueMap(ENTITY entity
            , Map<String, ? extends Object> columnValueMap
            , Map<String, Eps<ENTITY>> entityPropertySetupperMap) {
        MapAssertUtil.assertColumnValueMapNotNullAndNotEmpty(columnValueMap);
        MapStringValueAnalyzer analyzer = new MapStringValueAnalyzer(columnValueMap, entity.getModifiedPropertyNames());
        List<Sample1ColumnInfo> columnInfoList = getColumnInfoList();
        for (Sample1ColumnInfo columnInfo : columnInfoList) {
            String columnName = columnInfo.getColumnDbName();
            String propertyName = columnInfo.getPropertyName();
            String uncapPropName = initUncap(propertyName);
    ...
    protected String doExtractPrimaryKeyMapString(Sample1Entity entity
                                                , String startBrace
                                                , String endBrace
                                                , String delimiter
                                                , String equal) {
    ...
    protected String doExtractColumnValueMapString(Sample1Entity entity
                                                 , String startBrace
                                                 , String endBrace
                                                 , String delimiter
                                                 , String equal) {
    ...
    //                                               Convert
    //                                               -------
    protected Map<String, Object> doConvertToColumnValueMap(Sample1Entity entity) {
    ...
    protected Map<String, String> doConvertToColumnStringValueMap(Sample1Entity entity) {
    ...
    //                                                               =====================
	// It's very INTERNAL!
    protected <ENTITY extends Sample1Entity> void setupEps(Map<String, Eps<ENTITY>> entityPropertySetupperMap
                                                           , Eps<ENTITY> setupper
                                                           , Sample1ColumnInfo columnInfo) {
        String columnName = columnInfo.getColumnDbName();
        String propertyName = columnInfo.getPropertyName();
        registerEntityPropertySetupper(columnName, propertyName, setupper, entityPropertySetupperMap);
    }

    protected <ENTITY extends Sample1Entity> void registerEntityPropertySetupper(
		                                          String columnName
												, String propertyName
	                                            , Eps<ENTITY> setupper
											    , Map<String, Eps<ENTITY>> entityPropertySetupperMap) {
    ...
    protected <ENTITY extends Sample1Entity> Eps<ENTITY> findEps(Map<String, Eps<ENTITY>> entityPropertySetupperMap, String propertyName) {
    ...
    protected static class MapStringUtil {
        ...
        public static void acceptPrimaryKeyMapString(String primaryKeyMapString, Sample1Entity entity) {
            ...
            Sample1MapListString mapListString = createMapListString();
            entity.getDBMeta().acceptPrimaryKeyMap(entity, mapListString.generateMap(primaryKeyMapString));
        }

        public static void acceptColumnValueMapString(String columnValueMapString, Sample1Entity entity) {
        ...
        public static String extractPrimaryKeyMapString(Sample1Entity entity) {
        ...
        public static String extractColumnValueMapString(Sample1Entity entity) {
            final String startBrace = MAP_STRING_START_BRACE;
            final String endBrace = MAP_STRING_END_BRACE;
            final String delimiter = MAP_STRING_DELIMITER;
            final String equal = MAP_STRING_EQUAL;
        ...
        public static Sample1MapListString createMapListString() {
            final Sample1MapListString mapListString = new Sample1MapListStringImpl();
        ...
        public static Sample1MapStringBuilder createMapStringBuilder(List<String> columnNameList) {
            Sample1MapStringBuilder mapStringBuilder = new Sample1MapStringBuilderImpl();
    ...
    //                                                                       Assist Helper
    //                                                                       =============
	protected <ENTITY> ENTITY downcast(Sample1Entity entity) {
		checkDowncast(entity);
		return (ENTITY)entity;
	}

    protected void checkDowncast(Sample1Entity entity) {
        assertObjectNotNull("entity", entity);
        Class<? extends Sample1Entity> entityType = getEntityType();
        Class<? extends Sample1Entity> targetType = entity.getClass();
    ...
    protected Map<String, String> setupKeyToLowerMap(boolean dbNameKey) {
        ...
        try {
            for (Method method : methods) {
                ...
                Sample1ColumnInfo columnInfo = (Sample1ColumnInfo)method.invoke(this);
    ...
    protected String initUncap(String str) {
	    return Sample1SimpleStringUtil.initUncap(str);
    }
