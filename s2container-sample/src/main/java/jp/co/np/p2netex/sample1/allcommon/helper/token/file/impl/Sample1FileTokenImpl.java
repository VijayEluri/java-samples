...
import jp.co.np.p2netex.sample1.allcommon.helper.token.line.Sample1LineToken;
import jp.co.np.p2netex.sample1.allcommon.helper.token.line.Sample1LineTokenizingOption;
import jp.co.np.p2netex.sample1.allcommon.helper.token.line.Sample1LineMakingOption;
import jp.co.np.p2netex.sample1.allcommon.helper.token.line.impl.Sample1LineTokenImpl;

/**
 * @author DBFlute(AutoGenerator)
 */
public class Sample1FileTokenImpl implements Sample1FileToken {

    // =====================================================================================
    //                                                                             Attribute
    //                                                                             =========
    /** Line-token for help. */
    protected final Sample1LineToken _lineToken = new Sample1LineTokenImpl();
     ...
     */
    public void tokenize(String filename, Sample1FileTokenizingCallback fileTokenizingCallback, Sample1FileTokenizingOption fileTokenizingOption) throws java.io.FileNotFoundException, java.io.IOException {
     ...
     * @throws java.io.IOException
     */
    public void tokenize(java.io.InputStream inputStream, Sample1FileTokenizingCallback fileTokenizingCallback, Sample1FileTokenizingOption fileTokenizingOption) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        try {
            ...
            Sample1FileTokenizingHeaderInfo fileTokenizingHeaderInfo = null;
            int count = -1;
            int rowNumber = 1;
            int lineNumber = 0;
            while (true) {
                ...
                if (count == 0) {
                    if (fileTokenizingOption.isBeginFirstLine()) {
                        fileTokenizingHeaderInfo = new Sample1FileTokenizingHeaderInfo();// As empty
                    } else {
                ...
                try {
                    final Sample1FileTokenizingRowResource fileTokenizingRowResource = new Sample1FileTokenizingRowResource();
    ...
    protected ValueLineInfo arrangeValueList(final String lineString, String delimiter) {
        ...
        final Sample1LineTokenizingOption tokenizingOption = new Sample1LineTokenizingOption();
    ...
    protected Sample1FileTokenizingHeaderInfo analyzeHeaderInfo(String delimiter, final String lineString) {
        ...
        final Sample1FileTokenizingHeaderInfo fileTokenizingHeaderInfo = new Sample1FileTokenizingHeaderInfo();
     ...
     * @throws java.io.IOException
     */
    public void make(String filename, Sample1FileMakingCallback fileMakingCallback, Sample1FileMakingOption fileMakingOption) throws java.io.FileNotFoundException, java.io.IOException {
        assertStringNotNullAndNotTrimmedEmpty("filename", filename);
     ...
     * @throws java.io.IOException
     */
    public void make(java.io.OutputStream outputStream, Sample1FileMakingCallback fileMakingCallback, Sample1FileMakingOption fileMakingOption) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        try {
            ...
            // Make header.
            final Sample1FileMakingHeaderInfo fileMakingHeaderInfo = fileMakingOption.getFileMakingHeaderInfo();
            if (fileMakingHeaderInfo != null) {
                final List<String> columnNameList = fileMakingHeaderInfo.getColumnNameList();
                if (columnNameList != null && !columnNameList.isEmpty()) {
                    final Sample1LineMakingOption lineMakingOption = new Sample1LineMakingOption();
            ...
            // Make row.
            Sample1FileMakingRowResource rowResource = null;
            while (true) {
