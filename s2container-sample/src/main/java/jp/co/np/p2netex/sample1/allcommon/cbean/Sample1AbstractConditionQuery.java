...
import jp.co.np.p2netex.sample1.allcommon.cbean.coption.Sample1FromToOption;
import jp.co.np.p2netex.sample1.allcommon.cbean.coption.Sample1LikeSearchOption;
import jp.co.np.p2netex.sample1.allcommon.cbean.coption.Sample1InScopeOption;
...
import jp.co.np.p2netex.sample1.allcommon.exception.Sample1RequiredOptionNotFoundException;
 ...
 */
public abstract class Sample1AbstractConditionQuery implements Sample1ConditionQuery {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    protected static final Sample1ConditionKey CK_EQ = Sample1ConditionKey.CK_EQUAL;
    protected static final Sample1ConditionKey CK_NE = Sample1ConditionKey.CK_NOT_EQUAL;
    protected static final Sample1ConditionKey CK_GE = Sample1ConditionKey.CK_GREATER_EQUAL;
    protected static final Sample1ConditionKey CK_GT = Sample1ConditionKey.CK_GREATER_THAN;
    protected static final Sample1ConditionKey CK_LE = Sample1ConditionKey.CK_LESS_EQUAL;
    protected static final Sample1ConditionKey CK_LT = Sample1ConditionKey.CK_LESS_THAN;
    protected static final Sample1ConditionKey CK_PS = Sample1ConditionKey.CK_PREFIX_SEARCH;
    protected static final Sample1ConditionKey CK_LS = Sample1ConditionKey.CK_LIKE_SEARCH;
    protected static final Sample1ConditionKey CK_INS = Sample1ConditionKey.CK_IN_SCOPE;
    protected static final Sample1ConditionKey CK_NINS = Sample1ConditionKey.CK_NOT_IN_SCOPE;
    protected static final Sample1ConditionKey CK_ISN = Sample1ConditionKey.CK_IS_NULL;
    protected static final Sample1ConditionKey CK_ISNN = Sample1ConditionKey.CK_IS_NOT_NULL;

    /** Condition value for DUMMY. */
    protected static final Sample1ConditionValue DUMMY_CONDITION_VALUE = new Sample1ConditionValue();
    ...
    /** The query of child. */
    protected final Sample1ConditionQuery _childQuery;
     ...
     */
    public Sample1AbstractConditionQuery(Sample1ConditionQuery childQuery, Sample1SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public Sample1ConditionQuery getChildQuery() {
        return _childQuery;
    }
     ...
     */
    public Sample1SqlClause getSqlClause() {
        return _sqlClause;
    }
     ...
     */
    public boolean isBaseQuery(Sample1ConditionQuery query) {
     ...
     * @return Next nest level.
     */
    protected String getLocation(String columnPropertyName, Sample1ConditionKey key) {
        return getLocationBase(columnPropertyName) + "." + key.getConditionKey();
    }

    protected String getLocationBase() {
        final StringBuffer sb = new StringBuffer();
        Sample1ConditionQuery query = this;
        while (true) {
    ...
    protected Map<String, Sample1ConditionQuery> _unionQueryMap;

    /**
     * Get the map of union query.
     * @return The map of union query. (NotNull)
     */
    public Map<String, Sample1ConditionQuery> getUnionQueryMap() {// for Internal
        if (_unionQueryMap == null) {
            _unionQueryMap = new LinkedHashMap<String, Sample1ConditionQuery>();
        }
     ...
     */
    public void xsetUnionQuery(Sample1ConditionQuery unionQuery) {
        xsetupUnion(unionQuery, false, getUnionQueryMap());
    }

    /** The map of union all query. */
    protected Map<String, Sample1ConditionQuery> _unionAllQueryMap;

    /**
     * Get the map of union all query.
     * @return The map of union all query. (NotNull)
     */
    public Map<String, Sample1ConditionQuery> getUnionAllQueryMap() {// for Internal
        if (_unionAllQueryMap == null) {
            _unionAllQueryMap = new LinkedHashMap<String, Sample1ConditionQuery>();
        }
     ...
     */
    public void xsetUnionAllQuery(Sample1ConditionQuery unionAllQuery) {
        xsetupUnion(unionAllQuery, true, getUnionAllQueryMap());
    }

    protected void xsetupUnion(Sample1ConditionQuery unionQuery, boolean unionAll, Map<String, Sample1ConditionQuery> unionQueryMap) {
        if (unionQuery == null) {
     ...
     */
    abstract protected void reflectRelationOnUnionQuery(Sample1ConditionQuery baseQueryAsSuper, Sample1ConditionQuery unionQueryAsSuper);
     ...
     */
    public List<Sample1ConditionQuery> getUnionQueryList() {
        if (_unionQueryMap == null) { return new ArrayList<Sample1ConditionQuery>(); }
        return new ArrayList<Sample1ConditionQuery>(_unionQueryMap.values());
    }
     ...
     */
    public List<Sample1ConditionQuery> getUnionAllQueryList() {
        if (_unionAllQueryMap == null) { return new ArrayList<Sample1ConditionQuery>(); }
        return new ArrayList<Sample1ConditionQuery>(_unionAllQueryMap.values());
    }
    ...
    //                                                 Query
    //                                                 -----
    protected void registerQuery(Sample1ConditionKey key, Object value, Sample1ConditionValue cvalue
    ...
    //                                          FromTo Query
    //                                          ------------
    protected void registerFromToQuery(java.util.Date fromDate, java.util.Date toDate, Sample1ConditionValue cvalue
                                 , String colName, String capPropName, String uncapPropName, Sample1FromToOption option) {
        {
            final java.util.Date filteredFromDate = option.filterFromDate(fromDate);
            final Sample1ConditionKey fromKey = option.getFromDateConditionKey();
        ...
        }
        {
            ...
            final Sample1ConditionKey toKey = option.getToDateConditionKey();
    ...
    protected void registerLikeSearchQuery(Sample1ConditionKey key
                                         , String value
                                         , Sample1ConditionValue cvalue
                                         , String colName
                                         , String capPropName
                                         , String uncapPropName
                                         , Sample1LikeSearchOption option) {
        ...
        if (!option.isAsOrSplit()) {
            ...
            for (int i = 0; i < strArray.length; i++) {
                ...
                final List<Sample1LikeSearchOption.LikeAsOrCallback> callbackList = option.getLikeAsOrCallbackList();
                if (!callbackList.isEmpty()) {
                    getSqlClause().makeAdditionalConditionAsOrEffective();
                    for (Iterator<Sample1LikeSearchOption.LikeAsOrCallback> ite = callbackList.iterator(); ite.hasNext();) {
                        final Sample1LikeSearchOption.LikeAsOrCallback likeAsOrCallback = (Sample1LikeSearchOption.LikeAsOrCallback) ite.next();
                        ...
                        final Sample1LikeSearchOption optionDeepCopy = (Sample1LikeSearchOption) option.createDeepCopy();
                        optionDeepCopy.clearLikeAsOrCallback();
                        final Sample1LikeSearchOption filteredOption = likeAsOrCallback.filterOption(optionDeepCopy);
    ...
    protected void throwLikeSearchOptionNotFoundException(String capPropName, String value) {
        ...
        msg = msg + "* * * * * * * * * */" + getLineSeparator();
        throw new Sample1RequiredOptionNotFoundException(msg);
    }
        
    protected void invokeSetterLikeSearch(String columnFlexibleName, Object value, Sample1LikeSearchOption option) {
        if (value == null) {
            return;
        }
        final Sample1DBMeta dbmeta = Sample1DBMetaInstanceHandler.findDBMeta(getTableDbName());
        ...
        Method method = null;
        try {
            method = this.getClass().getMethod(methodName, new Class[]{value.getClass(), Sample1LikeSearchOption.class});
    ...
    //                                         InScope Query
    //                                         -------------
    protected void registerInScopeQuery(Sample1ConditionKey key, String value, Sample1ConditionValue cvalue
                                     , String colName, String capPropName, String uncapPropName, Sample1InScopeOption option) {
        if (key.isValidRegistration(cvalue, value, key.getConditionKey() + " of " + getRealAliasName() + "." + colName)) {
            if (value != null && option.isSplit()) {
                final String[] strArray = option.generateSplitValueArray(value);
    ...
    //                                          Inline Query
    //                                          ------------
    protected void registerInlineQuery(Sample1ConditionKey key, Object value, Sample1ConditionValue cvalue
                                       , String colName, String capPropName, String uncapPropName) {
        if (key.isValidRegistration(cvalue, value, key.getConditionKey() + " of " + getRealAliasName() + "." + colName)) {
    ...
    protected void registerInScopeSubQuery(Sample1ConditionQuery subQuery
                                 , String columnName, String relatedColumnName, String propertyName) {
        registerInScopeSubQuery(subQuery, columnName, relatedColumnName, propertyName, null);
    }

    protected void registerNotInScopeSubQuery(Sample1ConditionQuery subQuery
                                 , String columnName, String relatedColumnName, String propertyName) {
    ...
    protected String getInScopeSubQuerySql(Sample1ConditionQuery subQuery
    ...
    protected void registerNotExistsSubQuery(Sample1ConditionQuery subQuery
                                 , String columnName, String relatedColumnName, String propertyName) {
    ...
    protected String getExistsSubQuerySql(Sample1ConditionQuery subQuery
    ...
    //                                        DeriveSubQuery
    //                                        --------------
    protected void registerDeriveSubQuery(String function, Sample1ConditionQuery subQuery
    ...
    protected String getDeriveSubQuerySql(String function, Sample1ConditionQuery subQuery
    ...
    protected void assertDeriveReferrerColumnType(String function, Sample1ConditionQuery subQuery, String deriveColumnName) {
        final Sample1DBMeta dbmeta = Sample1DBMetaInstanceHandler.findDBMeta(subQuery.getTableDbName());
    ...
    //                                           Union Query
    //                                           -----------
    public void registerUnionQuery(Sample1ConditionQuery unionQuery, boolean unionAll, String unionQueryPropertyName) {
    ...
    protected String getUnionQuerySql(Sample1ConditionQuery unionQuery, String unionQueryPropertyName) {
     ...
     */
    public Sample1ConditionValue invokeValue(String columnFlexibleName) {
        ...
        return (Sample1ConditionValue)helpInvokingCQMethod(this, method, new Object[]{});
    }
    ...
    public void invokeQuery(String columnFlexibleName, String conditionKeyName, Object value) {
        ...
        final Sample1ConditionQuery cq = container.getConditionQuery();
        final Sample1DBMeta dbmeta = Sample1DBMetaInstanceHandler.findDBMeta(cq.getTableDbName());
     ...
     */
    public Sample1ConditionQuery invokeForeignCQ(String foreignPropertyName) {
        ...
        return (Sample1ConditionQuery)helpInvokingCQMethod(this, method, new Object[]{});
    }
    ...
    private static class PropertyNameCQContainer {
        ...
        protected Sample1ConditionQuery _cq;
        public PropertyNameCQContainer(String propertyName, Sample1ConditionQuery cq) {
        ...
        public Sample1ConditionQuery getConditionQuery() {
            return _cq;
        }
    }

    private Method helpGettingCQMethod(Sample1ConditionQuery cq, String methodName, Class<?>[] argTypes, String property) {
        try {
    ...
    private Object helpInvokingCQMethod(Sample1ConditionQuery cq, Method method, Object[] args) {
        try {
    ...
    public static interface NssCall {// Very Internal
        public Sample1ConditionQuery qf();
    }

    protected void registerOuterJoin(Sample1ConditionQuery cq, Map<String, String> joinOnMap) {
    ...
    protected String initCap(String str) {
        return Sample1SimpleStringUtil.initCap(str);
    }
    ...
    protected String convertObjectArrayToStringView(Object[] objArray) {
	    return Sample1TraceViewUtil.convertObjectArrayToStringView(objArray);
    }
