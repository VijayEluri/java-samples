...
public abstract class Sample1AbstractSqlClause implements Sample1SqlClause {
    ...
    /** Order-by clause. */
    protected final Sample1OrderByClause _orderByClause = new Sample1OrderByClause();
    ...
    protected List<Sample1WhereClauseSimpleFilter> _whereClauseSimpleFilterList;
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample1AbstractSqlClause(String tableName) {
        if (tableName == null) {
    ...
    public String getSelectClause() {
        StringBuilder sb = new StringBuilder();
        Sample1DBMeta dbmeta = Sample1DBMetaInstanceHandler.findDBMeta(_tableName);
        List<Sample1ColumnInfo> columnInfoList = dbmeta.getColumnInfoList();
    ...
    public String getSelectClausePKOnly() {
        StringBuilder sb = new StringBuilder();
        Sample1DBMeta dbmeta = Sample1DBMetaInstanceHandler.findDBMeta(_tableName);
        Sample1UniqueInfo uniqueInfo = dbmeta.getPrimaryUniqueInfo();
        List<Sample1ColumnInfo> columnInfoList = uniqueInfo.getUniqueColumnList();
        for (Sample1ColumnInfo columnInfo : columnInfoList) {
            String columnName = columnInfo.getColumnDbName();
            if (sb.length() > 0) {
                sb.append(", ");
    ...
    //                                                                          Copy Parts
    //                                                                          ==========
    public void copyIncludedSelectColumn(Sample1SqlClause sqlClause) {
    ...
    protected Map<String, SelectedSelectColumnInfo> createSelectedSelectColumnInfo(String foreignTableAliasName
                                                                                 ...
                                                                                 , String foreignPropertyName
                                                                                 , String localRelationPath) {
        final Sample1DBMeta dbmeta = Sample1DBMetaInstanceHandler.findDBMeta(localTableName);
        final Sample1ForeignInfo foreignInfo = dbmeta.findForeignInfo(foreignPropertyName);
        ...
        final Sample1DBMeta foreignDBMeta = foreignInfo.getForeignDBMeta();
        final List<Sample1ColumnInfo> columnInfoList = foreignDBMeta.getColumnInfoList();
        for (Sample1ColumnInfo columnInfo : columnInfoList) {
    ...
    //                                                                               Where
    //                                                                               =====
    public void registerWhereClause(String columnFullName, Sample1ConditionKey key, Sample1ConditionValue value) {
    ...
    public void registerWhereClause(String columnFullName, Sample1ConditionKey key, Sample1ConditionValue value, Sample1ConditionOption option) {
        assertStringNotNullAndNotTrimmedEmpty("columnFullName", columnFullName);
    ...
    //                                                                         InlineWhere
    //                                                                         ===========
    public void registerBaseTableInlineWhereClause(String columnName, Sample1ConditionKey key, Sample1ConditionValue value) {
    ...
    public void registerBaseTableInlineWhereClause(String columnName, Sample1ConditionKey key, Sample1ConditionValue value, Sample1ConditionOption option) {
        assertStringNotNullAndNotTrimmedEmpty("columnName", columnName);
    ...
    public void registerOuterJoinInlineWhereClause(String aliasName, String columnName, Sample1ConditionKey key, Sample1ConditionValue value, boolean onClauseInline) {
    ...
    public void registerOuterJoinInlineWhereClause(String aliasName, String columnName, Sample1ConditionKey key, Sample1ConditionValue value, Sample1ConditionOption option, boolean onClauseInline) {
        assertNotYetOuterJoin(aliasName);
        assertStringNotNullAndNotTrimmedEmpty("columnName", columnName);
        final LeftOuterJoinInfo joinInfo = (LeftOuterJoinInfo)_outerJoinMap.get(aliasName);
        if (onClauseInline) {
    ...
    public Sample1SqlClause clearOrderBy() {
        _isOrderByEffective = false;
        _orderByClause.clear();
        return this;
    }

    public Sample1SqlClause ignoreOrderBy() {
        _isOrderByEffective = false;
        return this;
    }

    public Sample1SqlClause makeOrderByEffective() {
    ...
    public void registerOrderBy(String orderByProperty, String registeredOrderByProperty, boolean ascOrDesc) {
        try {
            ...
            for (final Iterator<String> ite = orderByList.iterator(); ite.hasNext(); ) {
                ...
                Sample1OrderByElement element = new Sample1OrderByElement();
    ...
    protected Sample1OrderByClause.OrderByNullsSetupper createOrderByNullsSetupper() {// As Default
        return new Sample1OrderByClause.OrderByNullsSetupper() {
    ...
    protected Sample1OrderByClause.OrderByNullsSetupper createOrderByNullsSetupperByCaseWhen() {// Helper For Nulls Unsupported Database
        return new Sample1OrderByClause.OrderByNullsSetupper() {
            public String setup(String columnName, String orderByElementClause, boolean nullsFirst) {
     ...
     * @return this. (NotNull)
     */
    public Sample1SqlClause fetchFirst(int fetchSize) {
     ...
     * @return this. (NotNull)
     */
    public Sample1SqlClause fetchScope(int fetchStartIndex, int fetchSize) {
        _isFetchScopeEffective = true;
     ...
     * @return this. (NotNull)
     */
    public Sample1SqlClause fetchPage(int fetchPageNumber) {
        _isFetchScopeEffective = true;
    ...
    public Sample1SqlClause ignoreFetchScope() {
        _isFetchScopeEffective = false;
        doClearFetchPageClause();
        return this;
    }

    public Sample1SqlClause makeFetchScopeEffective() {
    ...
    //                                                            ==========================
    public void addWhereClauseSimpleFilter(Sample1WhereClauseSimpleFilter whereClauseSimpleFilter) {
        if (_whereClauseSimpleFilterList == null) {
            _whereClauseSimpleFilterList = new ArrayList<Sample1WhereClauseSimpleFilter>();
        }
    ...
    protected String filterWhereClauseSimply(String clauseElement) {
        ...
        for (final Iterator<Sample1WhereClauseSimpleFilter> ite = _whereClauseSimpleFilterList.iterator(); ite.hasNext(); ) {
            final Sample1WhereClauseSimpleFilter filter = ite.next();
            if (filter == null) {
    ...
    public void specifySelectColumn(String tableAliasName, String columnName) {
        ...
        _specifiedSelectColumnMap.put(tableAliasName, elementMap);// The value is dummy for extension at the future.
    }
    ...
    public void specifyDeriveSubQuery(String aliasName, String deriveSubQuery) {
        ...
        _specifiedDeriveSubQueryMap.put(aliasName, deriveSubQuery);// The value is dummy for extension at the future.
    }
    ...
    public String getClauseQueryUpdate(Map<String, String> columnParameterMap) {
        ...
        final Sample1DBMeta dbmeta = findDBMeta();
    ...
    protected Sample1DBMeta findDBMeta() {
        return Sample1DBMetaInstanceHandler.findDBMeta(_tableName); 
    }
