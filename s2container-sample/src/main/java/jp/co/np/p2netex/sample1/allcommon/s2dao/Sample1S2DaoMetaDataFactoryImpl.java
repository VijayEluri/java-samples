 ...
 */
public class Sample1S2DaoMetaDataFactoryImpl implements DaoMetaDataFactory, Disposable {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log-instance. */
    private static final org.apache.commons.logging.Log _log = org.apache.commons.logging.LogFactory.getLog(Sample1S2DaoMetaDataFactoryImpl.class);
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample1S2DaoMetaDataFactoryImpl(DataSource dataSource
        ...
        Sample1ConditionBeanContext.initialize();
        ...
        if (sqlLogRegistry != null) {
            Sample1InternalSqlLogRegistry.closeRegistration();
        ...
        Sample1DBFluteConfig.getInstance().lock();
        _log.info("* * * * */");
    }
    ...
    protected String getDatabaseProductNameFromContext() {
        return Sample1ConditionBeanContext.getDatabaseProductName();
    }

    protected void setDatabaseProductNameToContext(String name) {
        Sample1ConditionBeanContext.setDatabaseProductName(name);
    }

    protected boolean setupDatabaseProductNameByDriverClassName(String driverClassName) {
        return Sample1ConditionBeanContext.setupDatabaseProductNameByDriverClassName(driverClassName);
    }
    ...
    protected Sample1S2DaoMetaDataExtension createDaoMetaDataExtension() {
        final Sample1S2DaoMetaDataExtension dmdExtension = newDaoMetaDataExtension();
        ...
        dmdExtension.setInternalDebug(Sample1DBFluteConfig.getInstance().isInternalDebug());
        return dmdExtension;
    }

    protected Sample1S2DaoMetaDataExtension newDaoMetaDataExtension() {
        return new Sample1S2DaoMetaDataExtension();
    }
    ...
    protected ResultSetFactory createCustomizeResultSetFactory() {
        return new Sample1FetchNarrowingResultSetFactory();
    }
    ...
    protected StatementFactory createCustomizeStatememtFactory() {
        final Sample1StatementConfig defaultStatementConfig = Sample1DBFluteConfig.getInstance().getDefaultStatementConfig();
        final boolean internalDebug = Sample1DBFluteConfig.getInstance().isInternalDebug();
        return new StatementFactory() {
            public PreparedStatement createPreparedStatement(Connection con, String sql) {
                try {
                    final Sample1StatementConfig config = findStatementConfigOnThread();;
            ...
            protected Sample1StatementConfig findStatementConfigOnThread() {
                final Sample1StatementConfig config;
                ...
                } else if (Sample1OutsideSqlContext.isExistOutsideSqlContextOnThread()) {
                    final Sample1OutsideSqlContext context = Sample1OutsideSqlContext.getOutsideSqlContextOnThread();
            ...
            protected void reflectStatementOptions(Sample1StatementConfig config, PreparedStatement ps) {
                try {
