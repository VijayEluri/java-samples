 ...
 */
public class Sample1DBFluteConfig {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log instance. */
    private static final org.apache.commons.logging.Log _log = org.apache.commons.logging.LogFactory.getLog(Sample1DBFluteConfig.class);
	
    /** Singleton instance. */
    private static final Sample1DBFluteConfig _instance = new Sample1DBFluteConfig();

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
	protected Sample1StatementConfig _defaultStatementConfig;
     ...
     */
    public static Sample1DBFluteConfig getInstance() {
        return _instance;
    }
    ...
    //                                                            ========================
    public Sample1StatementConfig getDefaultStatementConfig() {
        return _defaultStatementConfig;
    }
	
    public void setDefaultStatementConfig(Sample1StatementConfig defaultStatementConfig) {
	    assertNotLocked();
