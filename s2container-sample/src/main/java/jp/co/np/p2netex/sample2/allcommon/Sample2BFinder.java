...
public class Sample2BFinder {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    protected static String _dbfluteDiconName = "dbflute-sample2.dicon";

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    private Sample2BFinder() {
    }

    // ===================================================================================
    //                                                                              Finder
    //                                                                             ======
    public static <BEHAVIOR_TYPE extends Sample2BehaviorReadable> BEHAVIOR_TYPE find(Class<BEHAVIOR_TYPE> behaviorType) {
        ...
        if (!org.seasar.framework.container.factory.SingletonS2ContainerFactory.hasContainer()) {
            synchronized (Sample2BFinder.class) {
                if (!org.seasar.framework.container.factory.SingletonS2ContainerFactory.hasContainer()) {
