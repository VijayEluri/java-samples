package jp.co.np.p2netex.sample1.allcommon.helper.collection.order.impl;
...
import jp.co.np.p2netex.sample1.allcommon.helper.collection.order.Sample1AccordingToOrder;
import jp.co.np.p2netex.sample1.allcommon.helper.collection.order.Sample1AccordingToOrderIdExtractor;
import jp.co.np.p2netex.sample1.allcommon.helper.collection.order.Sample1AccordingToOrderOption;

/**
 * @author DBFlute(AutoGenerator)
 */
public class Sample1AccordingToOrderImpl implements Sample1AccordingToOrder {
     ...
     */
    public <ELEMENT_TYPE, ID_TYPE> void order(final List<ELEMENT_TYPE> unorderedList, final Sample1AccordingToOrderOption<ELEMENT_TYPE, ID_TYPE> option) {
        ...
        final Sample1AccordingToOrderIdExtractor<ELEMENT_TYPE, ID_TYPE> idExtractor = option.getIdExtractor();
