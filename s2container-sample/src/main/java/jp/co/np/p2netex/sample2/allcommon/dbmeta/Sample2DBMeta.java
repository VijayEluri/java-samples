...
public interface Sample2DBMeta {
     ...
     */ 
    public Class<? extends Sample2Entity> getEntityType();
     ...
     */
    public Sample2UniqueInfo getPrimaryUniqueInfo();
     ...
     */ 
    public Sample2DBMeta findForeignDBMeta(String foreignPropName);
     ...
     */ 
    public Sample2ForeignInfo findForeignInfo(String foreignPropName);
     ...
     */
    public Sample2ColumnInfo getVersionNoColumnInfo();
     ...
     */
    public Sample2ColumnInfo getUpdateDateColumnInfo();
     ...
     */
    public String extractPrimaryKeyMapString(Sample2Entity entity);
     ...
     */
    public String extractColumnValueMapString(Sample2Entity entity);
     ...
     */
    public List<Object> convertToColumnValueList(Sample2Entity entity);
     ...
     */
    public Map<String, Object> convertToColumnValueMap(Sample2Entity entity);
     ...
     */
    public List<String> convertToColumnStringValueList(Sample2Entity entity);
     ...
     */
    public Map<String, String> convertToColumnStringValueMap(Sample2Entity entity);
     ...
     */
    public interface Eps<ENTITY_TYPE extends Sample2Entity> {
