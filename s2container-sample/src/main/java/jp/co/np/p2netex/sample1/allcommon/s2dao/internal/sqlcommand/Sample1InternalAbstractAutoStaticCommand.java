 ...
 */
public abstract class Sample1InternalAbstractAutoStaticCommand extends Sample1InternalAbstractStaticCommand {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample1InternalAbstractAutoStaticCommand(DataSource dataSource,
    ...
    public Object execute(Object[] args) {
        Sample1InternalAbstractAutoHandler handler = createAutoHandler();
    ...
    protected NotSingleRowUpdatedRuntimeException createNotSingleRowUpdatedRuntimeException(Object bean, int rows) {
        return new jp.co.np.p2netex.sample1.allcommon.exception.Sample1EntityAlreadyUpdatedException(bean, rows);
    }
    ...
    protected abstract Sample1InternalAbstractAutoHandler createAutoHandler();
