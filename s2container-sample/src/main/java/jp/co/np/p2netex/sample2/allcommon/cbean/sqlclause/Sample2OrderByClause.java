 ...
 */
public class Sample2OrderByClause implements java.io.Serializable {
    ...
    //                                                                             Attribute
    //                                                                             =========
    protected List<Sample2OrderByElement> _orderByList = new ArrayList<Sample2OrderByElement>();
     ...
     */
    public void addOrderByElement(Sample2OrderByElement orderByElement) {
     ...
     * @param orderByElement Order-by element. (NotNull)
     */
    public void insertFirstOrderByElement(Sample2OrderByElement orderByElement) {
        _orderByList.add(0, orderByElement);
    }

    public void reverseAll() {
        for (Iterator<Sample2OrderByElement> ite = _orderByList.iterator(); ite.hasNext(); ) {
            ite.next().reverse();
        }
    }
    ...
    public void exchangeFirstOrderByElementForLastOne() {
        if (_orderByList.size() > 1) {
            final Sample2OrderByElement first = _orderByList.get(0);
            final Sample2OrderByElement last = _orderByList.get(_orderByList.size() - 1);
    ...
    public List<Sample2OrderByElement> getOrderByList() {
        return _orderByList;
    }
    ...
    public String getOrderByClause(Map<String, String> selectClauseRealColumnAliasMap) {
        ...
        for (final Iterator<Sample2OrderByElement> ite = _orderByList.iterator(); ite.hasNext(); ) {
            final Sample2OrderByElement element = ite.next();
            sb.append(delimiter);
    ...
    public boolean isSameOrderByColumn(String orderByProperty) {
        ...
        for (final Iterator<String> ite = orderByList.iterator(); ite.hasNext(); ) {
            ...
            final Sample2OrderByElement element = (Sample2OrderByElement)_orderByList.get(count);
    ...
    public boolean isFirstElementAsc() {
        ...
        final Sample2OrderByElement element = (Sample2OrderByElement)_orderByList.get(0);
    ...
    public boolean isSameAsFirstElementAliasName(String expectedAliasName) {
        ...
        Sample2OrderByElement element = (Sample2OrderByElement)_orderByList.get(0);
     ...
     * @return Determination.
     */
    public java.util.Iterator<Sample2OrderByElement> iterator() {
