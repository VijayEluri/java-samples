 ...
 */
public class Sample2PageNumberLink implements java.io.Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample2PageNumberLink() {
    }

    // ===================================================================================
    //                                                                         Initializer
    //                                                                         ===========
    public Sample2PageNumberLink initialize(int pageNumberElement, boolean current, String pageNumberLinkHref) {
