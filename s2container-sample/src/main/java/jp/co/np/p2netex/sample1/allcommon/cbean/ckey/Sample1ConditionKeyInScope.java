 ...
 */
public class Sample1ConditionKeyInScope extends Sample1ConditionKey {

    /** Log-instance. */
    private static final Log _log = LogFactory.getLog(Sample1ConditionKeyInScope.class);

    /**
     * Constructor.
     */
    protected Sample1ConditionKeyInScope() {
    ...
    protected void doAddWhereClause(java.util.List<String> conditionList, String columnName, Sample1ConditionValue value, Sample1ConditionOption option) {
        ...
        if (!(option instanceof Sample1InScopeOption)) {
            String msg = "The argument[option] should be Sample1InScopeOption: columnName=" + columnName + " value=" + value;
            throw new IllegalArgumentException(msg);
        }
        conditionList.add(buildBindClause(columnName, value.getInScopeLocation(), "('a1', 'a2')"));
    }
    ...
    protected void doSetupConditionValue(Sample1ConditionValue conditionValue, Object value, String location, Sample1ConditionOption option) {
        conditionValue.setInScope((java.util.List<?>)value, (Sample1InScopeOption)option).setInScopeLocation(location);
    }
}
