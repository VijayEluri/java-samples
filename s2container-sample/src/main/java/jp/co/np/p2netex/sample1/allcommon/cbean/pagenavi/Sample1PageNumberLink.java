 ...
 */
public class Sample1PageNumberLink implements java.io.Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample1PageNumberLink() {
    }

    // ===================================================================================
    //                                                                         Initializer
    //                                                                         ===========
    public Sample1PageNumberLink initialize(int pageNumberElement, boolean current, String pageNumberLinkHref) {
