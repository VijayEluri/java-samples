...
import jp.co.np.p2netex.sample2.allcommon.s2dao.internal.sqlcommand.Sample2InternalAbstractDynamicCommand;
import jp.co.np.p2netex.sample2.allcommon.s2dao.internal.sqlhandler.Sample2InternalBasicSelectHandler;
...
public class Sample2S2DaoSelectDynamicCommand extends Sample2InternalAbstractDynamicCommand {
     ...
     */
    public Sample2S2DaoSelectDynamicCommand(DataSource dataSource,
    ...
    //                         -----------------------------
    protected Sample2S2DaoSelectDynamicCommand createMySelectDynamicCommand() {
        return new Sample2S2DaoSelectDynamicCommand(getDataSource(), getStatementFactory(), resultSetHandler, resultSetFactory);
    }
    ...
    public Object execute(Object[] args) {
        ...
        final Sample2InternalBasicSelectHandler selectHandler = createBasicSelectHandler(finalClause, this.resultSetHandler);
    ...
    protected Object executeDefault(Object args[]) {
        ...
        final Sample2InternalBasicSelectHandler selectHandler = createBasicSelectHandler(ctx.getSql(), specifiedResultSetHandler);
     ...
     * @return Result. (Nullable)
     */
    protected Object executeOutsideSqlAsStatic(Object[] args, Sample2OutsideSqlContext outsideSqlContext) {
        // - - - - - - - - - - - - - - - - -
        // Find specified resultSetHandler.
        // - - - - - - - - - - - - - - - - -
        final ResultSetHandler specifiedResultSetHandler = findSpecifiedResultSetHandler(args);
     ...
     * @return Result. (Nullable)
     */
    protected Object executeOutsideSqlAsDynamic(Object[] args, Sample2OutsideSqlContext outsideSqlContext) {
        ...
        final Sample2S2DaoSelectDynamicCommand outsideSqlCommand = createMySelectDynamicCommand();
    ...
    protected Object[] filterArgumentsForResultSetHandler(Object[] args) {
        ...
        final Object[] filteredArgs;
        if (args[args.length - 1] instanceof jp.co.np.p2netex.sample2.allcommon.jdbc.Sample2CursorHandler) {
    ...
    protected ResultSetHandler findSpecifiedResultSetHandler(Object[] args) {
        ...
        if (args[args.length-1] instanceof jp.co.np.p2netex.sample2.allcommon.jdbc.Sample2CursorHandler) {
            final jp.co.np.p2netex.sample2.allcommon.jdbc.Sample2CursorHandler cursorHandler = (jp.co.np.p2netex.sample2.allcommon.jdbc.Sample2CursorHandler)args[args.length-1];
    ...
    protected String setupRealClause(Object[] args, List<Object> bindVariableList, List<Class> bindVariableTypeList) {
        ...
        {
            final Sample2S2DaoSelectDynamicCommand dynamicCommand = createMySelectDynamicCommand();
    ...
    protected String setupRealSelectCountClause(Object[] args, List<Object> bindVariableList, List<Class> bindVariableTypeList) {
        ...
        {
            final Sample2S2DaoSelectDynamicCommand selectCountCommand = createMySelectDynamicCommand();
    ...
    protected Sample2InternalBasicSelectHandler createBasicSelectHandler(String realSql, ResultSetHandler specifiedResultSetHandler) {
        final Sample2InternalBasicSelectHandler selectHandler = newBasicSelectHandler(realSql, specifiedResultSetHandler, getStatementFactory(), resultSetFactory);
        selectHandler.setFetchSize(-1);
        return selectHandler;
    }

    protected Sample2InternalBasicSelectHandler newBasicSelectHandler(String sql, ResultSetHandler resultSetHandler, StatementFactory statementFactory, ResultSetFactory resultSetFactory) {
        return new Sample2InternalBasicSelectHandler(getDataSource(), sql, resultSetHandler, statementFactory, resultSetFactory) {
            @Override
