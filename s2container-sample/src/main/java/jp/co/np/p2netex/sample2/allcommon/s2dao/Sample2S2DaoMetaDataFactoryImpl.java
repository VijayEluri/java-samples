 ...
 */
public class Sample2S2DaoMetaDataFactoryImpl implements DaoMetaDataFactory, Disposable {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log-instance. */
    private static final org.apache.commons.logging.Log _log = org.apache.commons.logging.LogFactory.getLog(Sample2S2DaoMetaDataFactoryImpl.class);
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample2S2DaoMetaDataFactoryImpl(DataSource dataSource
        ...
        Sample2ConditionBeanContext.initialize();
        ...
        final Object sqlLogRegistry = Sample2InternalSqlLogRegistry.findContainerSqlLogRegistry();
        if (sqlLogRegistry != null) {
            Sample2InternalSqlLogRegistry.closeRegistration();
        ...
        Sample2DBFluteConfig.getInstance().lock();
        _log.info("* * * * */");
    }
    ...
    protected String getDatabaseProductNameFromContext() {
        return Sample2ConditionBeanContext.getDatabaseProductName();
    }

    protected void setDatabaseProductNameToContext(String name) {
        Sample2ConditionBeanContext.setDatabaseProductName(name);
    }

    protected boolean setupDatabaseProductNameByDriverClassName(String driverClassName) {
        return Sample2ConditionBeanContext.setupDatabaseProductNameByDriverClassName(driverClassName);
    }
    ...
    protected Sample2S2DaoMetaDataExtension createDaoMetaDataExtension() {
        final Sample2S2DaoMetaDataExtension dmdExtension = newDaoMetaDataExtension();
        ...
        dmdExtension.setInternalDebug(Sample2DBFluteConfig.getInstance().isInternalDebug());
        return dmdExtension;
    }

    protected Sample2S2DaoMetaDataExtension newDaoMetaDataExtension() {
        return new Sample2S2DaoMetaDataExtension();
    }
    ...
    protected ResultSetFactory createCustomizeResultSetFactory() {
        return new Sample2FetchNarrowingResultSetFactory();
    }
    ...
    protected StatementFactory createCustomizeStatememtFactory() {
        final Sample2StatementConfig defaultStatementConfig = Sample2DBFluteConfig.getInstance().getDefaultStatementConfig();
        final boolean internalDebug = Sample2DBFluteConfig.getInstance().isInternalDebug();
        return new StatementFactory() {
            public PreparedStatement createPreparedStatement(Connection con, String sql) {
                try {
                    final Sample2StatementConfig config = findStatementConfigOnThread();;
            ...
            protected Sample2StatementConfig findStatementConfigOnThread() {
                final Sample2StatementConfig config;
                ...
                } else if (Sample2OutsideSqlContext.isExistOutsideSqlContextOnThread()) {
                    final Sample2OutsideSqlContext context = Sample2OutsideSqlContext.getOutsideSqlContextOnThread();
            ...
            protected void reflectStatementOptions(Sample2StatementConfig config, PreparedStatement ps) {
                try {
