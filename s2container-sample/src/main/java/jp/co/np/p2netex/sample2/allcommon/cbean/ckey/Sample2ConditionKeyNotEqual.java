 ...
 */
public class Sample2ConditionKeyNotEqual extends Sample2ConditionKey {

    /** Log-instance. */
    private static final Log _log = LogFactory.getLog(Sample2ConditionKeyNotEqual.class);

    /**
     * Constructor.
     */
    protected Sample2ConditionKeyNotEqual() {
