...
import jp.co.np.p2netex.sample2.cbean.cq.bs.Sample2BsSample2EmpCQ;

/**
 * The condition-query of SAMPLE2_EMP.
 * <p>
...
public class Sample2Sample2EmpCQ extends Sample2BsSample2EmpCQ {
     ...
     */
    public Sample2Sample2EmpCQ(Sample2ConditionQuery childQuery, Sample2SqlClause sqlClause, String aliasName, int nestLevel) {
