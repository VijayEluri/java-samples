...
import jp.co.np.p2netex.sample2.allcommon.dbmeta.Sample2DBMeta.OptimisticLockType;
...
public class Sample2ColumnInfo {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample2ColumnInfo(Sample2DBMeta dbmeta, String columnDbName) {
        this(dbmeta, columnDbName, null, null, false, null, null);
    }

    public Sample2ColumnInfo(Sample2DBMeta dbmeta, String columnDbName, String propertyName
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof Sample2ColumnInfo)) {
            return false;
        }
        final Sample2ColumnInfo target = (Sample2ColumnInfo)obj;
