...
public class Sample1S2BeanMetaDataFactoryImpl extends BeanMetaDataFactoryImpl {

    protected Map<Class<? extends Sample1Entity>, BeanMetaData> _metaMap = Collections.synchronizedMap(new HashMap<Class<? extends Sample1Entity>, BeanMetaData>());
