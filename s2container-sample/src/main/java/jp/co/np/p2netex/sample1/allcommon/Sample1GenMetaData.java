 ...
 */
public class Sample1GenMetaData {

    /** Singleton instance. */
    private static final Sample1GenMetaData _instance = new Sample1GenMetaData();

    /**
     * Constructor.
     */
    private Sample1GenMetaData() {
    }
     ...
     */
    public static Sample1GenMetaData getInstance() {
        return _instance;
    }
    ...
    public String getBaseCommonPackage() {
        return "jp.co.np.p2netex.sample1.allcommon";
    }
    ...
    public String getBaseBehaviorPackage() {
        return "jp.co.np.p2netex.sample1.bsbhv";
    }
    ...
    public String getBaseDaoPackage() {
        return "jp.co.np.p2netex.sample1.bsdao";
    }
    ...
    public String getBaseEntityPackage() {
        return "jp.co.np.p2netex.sample1.bsentity";
    }
    ...
    public String getConditionBeanPackage() {
        return "jp.co.np.p2netex.sample1.cbean";
    }
    ...
    public String getExtendedDaoPackage() {
        return "jp.co.np.p2netex.sample1.exdao";
    }
    ...
    public String getExtendedBehaviorPackage() {
        return "jp.co.np.p2netex.sample1.exbhv";
    }
    ...
    public String getExtendedEntityPackage() {
        return "jp.co.np.p2netex.sample1.exentity";
    }
