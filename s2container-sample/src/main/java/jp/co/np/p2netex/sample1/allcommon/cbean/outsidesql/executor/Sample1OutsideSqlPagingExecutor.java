 ...
 */
public class Sample1OutsideSqlPagingExecutor {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample1OutsideSqlPagingExecutor(Sample1OutsideSqlDao outsideSqlDao, Sample1OutsideSqlOption outsideSqlOption, String tableDbName) {
    ...
    //                                                                              Select
    //                                                                              ======
    public <ENTITY> List<ENTITY> selectList(String path, Sample1PagingBean pmb, Class<ENTITY> entityType) {
     ...
     */
    public <ENTITY> Sample1PagingResultBean<ENTITY> selectPage(final String path
                                                               , final Sample1PagingBean pmb
                                                               , final Class<ENTITY> entityType) {
        final Sample1OutsideSqlOption countOption = _outsideSqlOption.copyOptionWithoutPaging();
        final Sample1OutsideSqlEntityExecutor<Sample1PagingBean> countExecutor = new Sample1OutsideSqlEntityExecutor<Sample1PagingBean>(_outsideSqlDao, countOption);
        final Sample1PagingHandler<ENTITY> handler = new Sample1PagingHandler<ENTITY>() {
        ...
        final Sample1PagingInvoker<ENTITY>  invoker = new Sample1PagingInvoker<ENTITY>(_tableDbName);
    ...
    protected void setupScrollableCursorIfNeeds() {
        ...
        Sample1StatementConfig statementConfig = _outsideSqlOption.getStatementConfig();
        if (statementConfig != null && statementConfig.getResultSetType() != null) {
            return;
        }
        Sample1StatementConfig defaultStatementConfig = Sample1DBFluteConfig.getInstance().getDefaultStatementConfig();
        if (defaultStatementConfig != null && defaultStatementConfig.hasResultSetType()) {
            return;
        }
        if (statementConfig == null) {
            statementConfig = new Sample1StatementConfig();
    ...
    //                                                                              Option
    //                                                                              ======
    public Sample1OutsideSqlCursorExecutor<Sample1PagingBean> cursorHandling() {
        return new Sample1OutsideSqlCursorExecutor<Sample1PagingBean>(_outsideSqlDao, _outsideSqlOption);
    }
	
    public Sample1OutsideSqlPagingExecutor configure(Sample1StatementConfig statementConfig) {
		_outsideSqlOption.setStatementConfig(statementConfig);
        return this;
    }

    public Sample1OutsideSqlPagingExecutor dynamicBinding() {
