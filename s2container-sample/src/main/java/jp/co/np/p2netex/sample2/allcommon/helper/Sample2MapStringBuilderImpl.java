package jp.co.np.p2netex.sample2.allcommon.helper;
 ...
 */
public class Sample2MapStringBuilderImpl implements Sample2MapStringBuilder {
    ...
    protected java.util.List<String> tokenize(String value, String delimiter) {
        final Sample2LineToken lineToken = new Sample2LineTokenImpl();
        final Sample2LineTokenizingOption lineTokenizingOption = new Sample2LineTokenizingOption();
