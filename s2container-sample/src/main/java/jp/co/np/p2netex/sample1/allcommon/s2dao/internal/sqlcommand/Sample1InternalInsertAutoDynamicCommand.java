...
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlhandler.Sample1InternalInsertAutoHandler;

/**
 * @author DBFlute(AutoGenerator)
 */
public class Sample1InternalInsertAutoDynamicCommand implements SqlCommand {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample1InternalInsertAutoDynamicCommand() {
    }
    ...
    public Object execute(Object[] args) {
        ...
        final Sample1InternalInsertAutoHandler handler = new Sample1InternalInsertAutoHandler(getDataSource(), getStatementFactory(), bmd, propertyTypes);
        handler.setSql(sql);
