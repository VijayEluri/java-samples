package jp.co.np.p2netex.sample1.allcommon.helper;
 ...
 */
public class Sample1MapStringBuilderImpl implements Sample1MapStringBuilder {
    ...
    protected java.util.List<String> tokenize(String value, String delimiter) {
        final Sample1LineToken lineToken = new Sample1LineTokenImpl();
        final Sample1LineTokenizingOption lineTokenizingOption = new Sample1LineTokenizingOption();
