package jp.co.np.p2netex.sample2.allcommon.s2dao.internal.util;
 ...
 */
public class Sample2InternalBindVariableUtil {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    private Sample2InternalBindVariableUtil() {
    }
    ...
    protected static String getLogDateFormat() {
        String logDateFormat = Sample2DBFluteConfig.getInstance().getLogDateFormat();
        return logDateFormat != null ? logDateFormat : "yyyy-MM-dd";
    }

    protected static String getLogTimestampFormat() {
        String logTimestampFormat = Sample2DBFluteConfig.getInstance().getLogTimestampFormat();
