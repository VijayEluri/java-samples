 ...
 */
public class Sample2OutsideSqlContext {

    /** Log instance. */
    private static final Log _log = LogFactory.getLog(Sample2OutsideSqlContext.class);
    
    // ===================================================================================
    //                                                                        Thread Local
    //                                                                        ============
    /** The thread-local for this. */
    private static final ThreadLocal<Sample2OutsideSqlContext> _threadLocal = new ThreadLocal<Sample2OutsideSqlContext>();

    /**
     * Get outside-SQL context on thread.
     * @return Outside-SQL context. (Nullable)
     */
    public static Sample2OutsideSqlContext getOutsideSqlContextOnThread() {
        return (Sample2OutsideSqlContext)_threadLocal.get();
    }
     ...
     */
    public static void setOutsideSqlContextOnThread(Sample2OutsideSqlContext outsideSqlContext) {
    ...
    //                                                                          Unique Key
    //                                                                          ==========
    public static String generateSpecifiedOutsideSqlUniqueKey(String methodName, String path, Object pmb, Sample2OutsideSqlOption option, Object resultTypeSpecification) {
    ...
    public static void throwOutsideSqlNotFoundException(String path) {
        ...
        msg = msg + "* * * * * * * * * */" + getLineSeparator();
        throw new jp.co.np.p2netex.sample2.allcommon.exception.Sample2OutsideSqlNotFoundException(msg);
    }
    ...
    protected String buildBehaviorSqlPackageName() {
        final Sample2DBMeta dbmeta = Sample2DBMetaInstanceHandler.findDBMeta(_tableDbName);
        final String behaviorTypeName = dbmeta.getBehaviorTypeName();
        final String outsideSqlPackage = Sample2DBFluteConfig.getInstance().getOutsideSqlPackage();
