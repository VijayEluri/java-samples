...
public class Sample2S2DaoPropertyTypeFactoryBuilderExtension extends FastPropertyTypeFactoryBuilder {
    ...
    protected static class FastPropertyTypeFactoryExtension extends FastPropertyTypeFactory {
        ...
        protected Sample2DBMeta _dbmeta;
        ...
        protected Sample2DBMeta findDBMeta() {
            try {
                final Sample2Entity entity = (Sample2Entity) beanClass.newInstance();
