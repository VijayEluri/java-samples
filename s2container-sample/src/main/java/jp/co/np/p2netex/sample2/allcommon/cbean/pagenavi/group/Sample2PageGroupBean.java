package jp.co.np.p2netex.sample2.allcommon.cbean.pagenavi.group;

import java.util.List;
import java.util.ArrayList;
import java.util.Iterator;

import jp.co.np.p2netex.sample2.allcommon.cbean.pagenavi.Sample2PageNumberLink;
import jp.co.np.p2netex.sample2.allcommon.cbean.pagenavi.Sample2PageNumberLinkSetupper;

/**
 * The bean of page group.
 * @author DBFlute(AutoGenerator)
 */
public class Sample2PageGroupBean implements java.io.Serializable {
     ...
     */
    public <LINK extends Sample2PageNumberLink> List<LINK> buildPageNumberLinkList(Sample2PageNumberLinkSetupper<LINK> pageNumberLinkSetupper) {
