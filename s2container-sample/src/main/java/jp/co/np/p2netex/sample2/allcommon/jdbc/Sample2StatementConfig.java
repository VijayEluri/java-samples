 ...
 */
public class Sample2StatementConfig {
    ...
    //                                        ResultSet TYPE
    //                                        --------------
    public Sample2StatementConfig typeForwardOnly() {
        _resultSetType = ResultSet.TYPE_FORWARD_ONLY;
        return this;
    }
    
    public Sample2StatementConfig typeScrollInsensitive() {
        _resultSetType = ResultSet.TYPE_SCROLL_INSENSITIVE;
        return this;
    }
    
    public Sample2StatementConfig typeScrollSensitive() {
    ...
    //                                      Statement Option
    //                                      ----------------
    public Sample2StatementConfig queryTimeout(int queryTimeout) {
        this._queryTimeout = queryTimeout;
        return this;
    }
	    
    public Sample2StatementConfig fetchSize(int fetchSize) {
        this._fetchSize = fetchSize;
        return this;
    }
    
    public Sample2StatementConfig maxRows(int maxRows) {
