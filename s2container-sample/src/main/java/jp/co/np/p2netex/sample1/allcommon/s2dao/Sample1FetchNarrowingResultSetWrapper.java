 ...
 */
public class Sample1FetchNarrowingResultSetWrapper extends ResultSetWrapper {
    ...
    protected Sample1FetchNarrowingBean _fetchNarrowingBean;
     ...
     */
    public Sample1FetchNarrowingResultSetWrapper(ResultSet resultSet, Sample1FetchNarrowingBean fetchNarrowingBean
    ...
    protected void checkSafetyResult(boolean hasNext) {
        if (hasNext && getSafetyMaxResultSize() > 0 && _requestCounter > (getSafetyMaxResultSize() + 1)) {
            ...
            throw new jp.co.np.p2netex.sample1.allcommon.exception.Sample1DangerousResultSizeException(msg, getSafetyMaxResultSize());
        }
    }
