...
import jp.co.np.p2netex.sample2.allcommon.cbean.grouping.Sample2GroupingOption;
import jp.co.np.p2netex.sample2.allcommon.cbean.grouping.Sample2GroupingRowEndDeterminer;
import jp.co.np.p2netex.sample2.allcommon.cbean.grouping.Sample2GroupingRowResource;
import jp.co.np.p2netex.sample2.allcommon.cbean.grouping.Sample2GroupingRowSetupper;
import jp.co.np.p2netex.sample2.allcommon.cbean.sqlclause.Sample2OrderByClause;

/**
 * The list-result-bean for Sample2ListResultBean.
 * @param <ENTITY> The type of entity for the element of selected list.
 * @author DBFlute(AutoGenerator)
 */
public class Sample2ListResultBean<ENTITY> implements List<ENTITY>, java.io.Serializable {
    ...
    /** Order-by clause. */
    protected Sample2OrderByClause _orderByClause = new Sample2OrderByClause();
     ...
     * Constructor.
     */
    public Sample2ListResultBean() {
    }

    // ===================================================================================
    //                                                                            Grouping
    //                                                                            ========
    public <ROW> List<ROW> groupingList(Sample2GroupingRowSetupper<ROW, ENTITY> groupingRowSetupper, Sample2GroupingOption<ENTITY> groupingOption) {
        final List<ROW> groupingList = new ArrayList<ROW>();
        Sample2GroupingRowEndDeterminer<ENTITY> rowEndDeterminer = groupingOption.getGroupingRowEndDeterminer();
        if (rowEndDeterminer == null) {
            rowEndDeterminer = new Sample2GroupingRowEndDeterminer<ENTITY>() {
        ...
        Sample2GroupingRowResource<ENTITY> rowResource = new Sample2GroupingRowResource<ENTITY>();
        ...
        for (ENTITY entity : _selectedList) {
            ...
            if (rowEndDeterminer.determine(columnIndex, columnCount, rowResource, nextElement)) {
                ...
                // Initialize!
                rowResource = new Sample2GroupingRowResource<ENTITY>();
                columnIndex = 0;
                ++rowIndex;
                continue;
            }
    ...
    //                                                                             Mapping
    //                                                                             =======
    public <DTO> Sample2ListResultBean<DTO> mappingList(Sample2EntityDtoMapper<ENTITY, DTO> entityDtoMapper) {
        final Sample2ListResultBean<DTO> mappingList = new Sample2ListResultBean<DTO>();
        for (ENTITY entity : _selectedList) {
     ...
     */
    public Sample2OrderByClause getOrderByClause() {
     ...
     */
    public void setOrderByClause(Sample2OrderByClause orderByClause) {
