 ...
 */
public class Sample1InternalProcedureHandler extends Sample1InternalBasicSelectHandler {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample1InternalProcedureHandler(final DataSource dataSource, final String sql,
    ...
    protected ResultSetHandler createOutParameterResultSetHandler(ProcedureParameterType ppt, ResultSet resultSet) {
        return new InternalMapListResultSetHandler();
    }
