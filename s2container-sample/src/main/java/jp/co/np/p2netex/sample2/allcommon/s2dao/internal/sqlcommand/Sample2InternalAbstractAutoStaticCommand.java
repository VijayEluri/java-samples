 ...
 */
public abstract class Sample2InternalAbstractAutoStaticCommand extends Sample2InternalAbstractStaticCommand {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample2InternalAbstractAutoStaticCommand(DataSource dataSource,
    ...
    public Object execute(Object[] args) {
        Sample2InternalAbstractAutoHandler handler = createAutoHandler();
    ...
    protected NotSingleRowUpdatedRuntimeException createNotSingleRowUpdatedRuntimeException(Object bean, int rows) {
        return new jp.co.np.p2netex.sample2.allcommon.exception.Sample2EntityAlreadyUpdatedException(bean, rows);
    }
    ...
    protected abstract Sample2InternalAbstractAutoHandler createAutoHandler();
