...
import jp.co.np.p2netex.sample2.allcommon.cbean.sqlclause.Sample2WhereClauseSimpleFilter;
 ...
 */
public abstract class Sample2AbstractConditionBean implements Sample2ConditionBean {
    ...
    {
        _sqlClause = Sample2ConditionBeanContext.createSqlClause(this);
    }
     ...
     */
    abstract public Sample2ConditionQuery getConditionQueryAsInterface();
    ...
    public void acceptPrimaryKeyMapString(String primaryKeyMapString) {
        ...
        Sample2MapListString mapListString = new Sample2MapListStringImpl();
    ...
    //                                                                             Specify
    //                                                                             =======
    protected static abstract class AbstractSpecification<CQ extends Sample2ConditionQuery> {
        protected Sample2ConditionBean _baseCB;
         ...
         */
        protected AbstractSpecification(Sample2ConditionBean baseCB, SpQyCall<CQ> qyCall, boolean forDeriveReferrer) {
            _baseCB = baseCB;
            _qyCall = qyCall;
    ...
    protected static interface SpQyCall<CQ extends Sample2ConditionQuery> {
        public boolean has(); 
        public CQ qy(); 
    }
    ...
    public static class RAFunction<REFERRER_CB extends Sample2ConditionBean, LOCAL_CQ extends Sample2ConditionQuery> {
        protected Sample2ConditionBean _baseCB;
        protected LOCAL_CQ _localCQ;
        protected RAQSetupper<REFERRER_CB, LOCAL_CQ> _querySetupper;
        public RAFunction(Sample2ConditionBean baseCB, LOCAL_CQ localCQ, RAQSetupper<REFERRER_CB, LOCAL_CQ> querySetupper) {
            _baseCB = baseCB;
            _localCQ = localCQ;
            _querySetupper = querySetupper;
        }
        public void max(Sample2SubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.setup("max", subQuery, _localCQ, aliasName.trim());
        }
        public void min(Sample2SubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.setup("min", subQuery, _localCQ, aliasName.trim());
        }
        public void sum(Sample2SubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.setup("sum", subQuery, _localCQ, aliasName.trim());
        }
        public void avg(Sample2SubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.setup("avg", subQuery, _localCQ, aliasName.trim());
        }
        public void count(Sample2SubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
        ...
        protected void assertAliasName(String aliasName) {
            ...
            Sample2DBMeta dbmeta = Sample2DBMetaInstanceHandler.findDBMeta(_baseCB.getTableDbName());
    ...
    public static interface RAQSetupper<REFERRER_CB extends Sample2ConditionBean, LOCAL_CQ extends Sample2ConditionQuery> {
        public void setup(String function, Sample2SubQuery<REFERRER_CB> subQuery, LOCAL_CQ cq, String aliasName);
    }
    ...
    protected void assertPrimaryKeyMap(Map<String, ? extends Object> primaryKeyMap) {
        ...
        List<Sample2ColumnInfo> columnInfoList = Sample2DBMetaInstanceHandler.findDBMeta(getTableDbName()).getPrimaryUniqueInfo().getUniqueColumnList();
    ...
    public String toDisplaySql() {
        return Sample2ConditionBeanContext.convertConditionBean2DisplaySql(this);
    }
