...
import jp.co.np.p2netex.sample2.allcommon.bhv.setup.Sample2ValueLabelBox;
...
import jp.co.np.p2netex.sample2.allcommon.cbean.outsidesql.executor.Sample2OutsideSqlBasicExecutor;

import jp.co.np.p2netex.sample2.allcommon.bhv.batch.Sample2TokenFileOutputOption;
import jp.co.np.p2netex.sample2.allcommon.bhv.batch.Sample2TokenFileOutputResult;
...
import jp.co.np.p2netex.sample2.allcommon.helper.token.file.Sample2FileMakingHeaderInfo;
import jp.co.np.p2netex.sample2.allcommon.helper.token.file.Sample2FileMakingSimpleFacade;
import jp.co.np.p2netex.sample2.allcommon.helper.token.file.impl.Sample2FileMakingSimpleFacadeImpl;
...
public abstract class Sample2AbstractBehaviorReadable implements Sample2BehaviorReadable {
    ...
    protected Sample2DaoSelector _daoSelector;
    ...
    public Sample2Entity readEntity(Sample2ConditionBean cb) {
        assertConditionBeanNotNull(cb);
        final java.util.List<Sample2Entity> ls = readList(cb);
        if (ls.isEmpty()) {
            return null;
        }
        assertEntitySelectedAsOne(ls, cb);
        return (Sample2Entity)ls.get(0);
    }
    ...
    protected <ENTITY_TYPE extends Sample2Entity, CB_TYPE extends Sample2ConditionBean>
        ...
        } catch (jp.co.np.p2netex.sample2.allcommon.exception.Sample2DangerousResultSizeException e) {
    ...
    protected static interface InternalSelectEntityCallback<ENTITY_TYPE extends Sample2Entity, CB_TYPE extends Sample2ConditionBean> {
    ...
    protected static interface InternalSelectEntityWithDeletedCheckCallback<ENTITY_TYPE extends Sample2Entity, CB_TYPE extends Sample2ConditionBean> {
        public java.util.List<ENTITY_TYPE> callbackSelectList(CB_TYPE cb);
    }
    ...
    public Sample2ListResultBean<Sample2Entity> readList(Sample2ConditionBean cb) {
        assertConditionBeanNotNull(cb);
        return new jp.co.np.p2netex.sample2.allcommon.cbean.Sample2ResultBeanBuilder<Sample2Entity>(getTableDbName()).buildListResultBean(cb, callReadList(cb));
    }
    ...
    public Sample2PagingResultBean<Sample2Entity> readPage(final Sample2ConditionBean cb) {
        assertConditionBeanNotNull(cb);
        final Sample2PagingInvoker<Sample2Entity> invoker = new Sample2PagingInvoker<Sample2Entity>(getTableDbName());
        final Sample2PagingHandler<Sample2Entity> handler = new Sample2PagingHandler<Sample2Entity>() {
            public Sample2PagingBean getPagingBean() { return cb; }
            public int count() { return readCount(cb); }
            public List<Sample2Entity> paging() { return readList(cb); }
        };
     ...
     * @exception jp.co.np.p2netex.sample2.allcommon.exception.Sample2EntityAlreadyDeletedException When the entity has already been deleted.
     */
    protected void assertEntityNotDeleted(jp.co.np.p2netex.sample2.allcommon.Sample2Entity entity, Object searchKey4Log) {
        if (entity == null) {
     ...
     * @exception jp.co.np.p2netex.sample2.allcommon.exception.Sample2EntityAlreadyDeletedException
     */
    ...
    //                                                                      Various Select
    //                                                                      ==============
    public Sample2OutsideSqlBasicExecutor outsideSql() {
        assertDaoSelectorNotNull("outsideSql");
        final Sample2OutsideSqlDao outsideSqlDao = _daoSelector.select(Sample2OutsideSqlDao.class);
        return new Sample2OutsideSqlBasicExecutor(outsideSqlDao, getTableDbName());
    }
     ...
     */
    public <ENTITY extends Sample2Entity> List<java.util.Map<String, Object>> createValueLabelList(List<ENTITY> entityList, Sample2ValueLabelSetupper<ENTITY> valueLabelSetupper) {
        final List<Map<String, Object>> valueLabelList = new ArrayList<Map<String, Object>>();
        final Sample2ValueLabelBox box = new Sample2ValueLabelBox();
     ...
     */
    protected <LOCAL_ENTITY_TYPE extends Sample2Entity, PK_TYPE, REFERRER_CB_TYPE extends Sample2ConditionBean, REFERRER_ENTITY_TYPE extends Sample2Entity>
            void helpLoadRefererInternally(java.util.List<LOCAL_ENTITY_TYPE> localEntityList
                                         , jp.co.np.p2netex.sample2.allcommon.bhv.load.Sample2LoadRefererOption<REFERRER_CB_TYPE, REFERRER_ENTITY_TYPE> loadReferrerOption
    ...
    protected <LOCAL_ENTITY_TYPE extends Sample2Entity, PK_TYPE, REFERRER_CB_TYPE extends Sample2ConditionBean, REFERRER_ENTITY_TYPE extends Sample2Entity>
            void helpLoadReferrerInternally(java.util.List<LOCAL_ENTITY_TYPE> localEntityList
                                         , jp.co.np.p2netex.sample2.allcommon.bhv.load.Sample2LoadReferrerOption<REFERRER_CB_TYPE, REFERRER_ENTITY_TYPE> loadReferrerOption
        ...
        helpLoadRefererInternally(localEntityList, new jp.co.np.p2netex.sample2.allcommon.bhv.load.Sample2LoadRefererOption<REFERRER_CB_TYPE, REFERRER_ENTITY_TYPE>(loadReferrerOption), compatibleCallback);
    }
     ...
     * @param <REFERRER_ENTITY_TYPE> The type of referrer entity.
     */
    protected static interface InternalLoadRefererCallback<LOCAL_ENTITY_TYPE extends Sample2Entity
                                                         , PK_TYPE, REFERRER_CB_TYPE extends Sample2ConditionBean
                                                         , REFERRER_ENTITY_TYPE extends Sample2Entity>
     ...
     * @param <REFERRER_ENTITY_TYPE> The type of referrer entity.
     */
    protected static interface InternalLoadReferrerCallback<LOCAL_ENTITY_TYPE extends Sample2Entity
                                                         , PK_TYPE, REFERRER_CB_TYPE extends Sample2ConditionBean
                                                         , REFERRER_ENTITY_TYPE extends Sample2Entity> {
        // For Base
        public PK_TYPE callbackBase_getPrimaryKeyValue(LOCAL_ENTITY_TYPE entity);
    ...
    //                                                             =======================
    protected <LOCAL_ENTITY_TYPE extends Sample2Entity, FOREIGN_ENTITY_TYPE extends Sample2Entity>
    ...
    protected static interface InternalPulloutCallback<LOCAL_ENTITY_TYPE extends Sample2Entity, FOREIGN_ENTITY_TYPE extends Sample2Entity> {
    ...
    public class TokenFileOutputExecutor {
         ...
         */
        public Sample2TokenFileOutputResult outputTokenFile(Sample2ConditionBean cb, String filename, Sample2TokenFileOutputOption tokenFileOutputOption) throws java.io.FileNotFoundException, java.io.IOException {
            assertConditionBeanNotNull(cb);
            ...
            for (java.util.Iterator ite = ls.iterator(); ite.hasNext(); ) {
                final Sample2Entity entity = (Sample2Entity)ite.next();
                final java.util.List<String> valueList = getDBMeta().convertToColumnStringValueList(entity);
                rowList.add(valueList);
            }
            final Sample2FileMakingSimpleFacade fileMakingSimpleFacade = new Sample2FileMakingSimpleFacadeImpl();
            final Sample2FileMakingOption fileMakingOption = tokenFileOutputOption.getFileMakingOption();
            final Sample2FileMakingHeaderInfo fileMakingHeaderInfo = new Sample2FileMakingHeaderInfo();
            ...
            final Sample2TokenFileOutputResult tokeFileOutputResult = new Sample2TokenFileOutputResult();
     ...
     */
    protected java.util.List<Sample2Entity> callGetListAll() {
        final java.lang.reflect.Method mtd = getMethod(getDaoReadable().getClass(), "getListAll", new Class[]{});
        final Object result = invoke(mtd, getDaoReadable(), new Object[]{});
        return (java.util.List<Sample2Entity>)result;
    }
     ...
     * @return Read count. (NotNull)
     */
    protected int callReadCount(Sample2ConditionBean cb) {
        assertConditionBeanNotNull(cb);
     ...
     */
    protected java.util.List<Sample2Entity> callReadList(Sample2ConditionBean cb) {
        assertConditionBeanNotNull(cb);
        final Class[] types = new Class[]{cb.getClass()};
    ...
    //                                                                ====================
    protected abstract boolean hasVersionNoValue(Sample2Entity entity);
    protected abstract boolean hasUpdateDateValue(Sample2Entity entity);
    ...
    protected <ENTITY_TYPE extends Sample2Entity> ENTITY_TYPE helpDowncastInternally(Sample2Entity entity, Class<ENTITY_TYPE> clazz) {
     ...
     */
    protected void assertEntityNotNull(Sample2Entity entity) {
        assertObjectNotNull("entity", entity);
    }
     ...
     * @param cb Condition-bean. (NotNull)
     */
    protected void assertConditionBeanNotNull(jp.co.np.p2netex.sample2.allcommon.cbean.Sample2ConditionBean cb) {
     ...
     * @param entity Entity. (NotNull)
     */
    protected void assertEntityNotNullAndHasPrimaryKeyValue(Sample2Entity entity) {
     ...
     */
    protected Sample2BehaviorSelector getBehaviorSelector() {
     ...
     */
    public void setBehaviorSelector(Sample2BehaviorSelector behaviorSelector) {
     ...
     * @return The select of behavior. (Nullable: But normally NotNull)
     */
    protected Sample2DaoSelector getDaoSelector() {
        return _daoSelector;
    }
     ...
     */
    public void setDaoSelector(Sample2DaoSelector daoSelector) {
