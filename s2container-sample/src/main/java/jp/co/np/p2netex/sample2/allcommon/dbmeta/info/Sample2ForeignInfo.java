...
public class Sample2ForeignInfo implements Sample2RelationInfo {
    ...
    protected Sample2DBMeta foreignDBMeta;
    protected java.util.Map<Sample2ColumnInfo, Sample2ColumnInfo> localForeignColumnInfoMap;
    protected java.util.Map<Sample2ColumnInfo, Sample2ColumnInfo> foreignLocalColumnInfoMap;
    ...
    //                                                                              Finder
    //                                                                              ======
    public Sample2ColumnInfo findLocalByForeign(String foreignColumnDbName) {
        final Sample2ColumnInfo keyColumnInfo = new Sample2ColumnInfo(foreignDBMeta, foreignColumnDbName);
        final Sample2ColumnInfo resultColumnInfo = (Sample2ColumnInfo)foreignLocalColumnInfoMap.get(keyColumnInfo);
    ...
    public Sample2DBMeta getForeignDBMeta() {
        return foreignDBMeta;
    }

    public void setForeignDBMeta(Sample2DBMeta foreignDBMeta) {
        this.foreignDBMeta = foreignDBMeta;
    }

    public java.util.Map<Sample2ColumnInfo, Sample2ColumnInfo> getLocalForeignColumnInfoMap() {
        return localForeignColumnInfoMap;
    }

    public void setLocalForeignColumnInfoMap(java.util.Map<Sample2ColumnInfo, Sample2ColumnInfo> localForeignColumnInfoMap) {
        this.localForeignColumnInfoMap = localForeignColumnInfoMap;
        final java.util.Set keySet = localForeignColumnInfoMap.keySet();
        foreignLocalColumnInfoMap = new java.util.LinkedHashMap<Sample2ColumnInfo, Sample2ColumnInfo>();
        for (final java.util.Iterator ite = keySet.iterator(); ite.hasNext(); ) {
            final Sample2ColumnInfo key = (Sample2ColumnInfo)ite.next();
            final Sample2ColumnInfo value = (Sample2ColumnInfo)localForeignColumnInfoMap.get(key);
            foreignLocalColumnInfoMap.put(value, key);
        }
    }

    public java.util.Map<Sample2ColumnInfo, Sample2ColumnInfo> getForeignLocalColumnInfoMap() {
