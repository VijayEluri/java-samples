...
import jp.co.np.p2netex.sample1.allcommon.cbean.sqlclause.Sample1WhereClauseSimpleFilter;
 ...
 */
public abstract class Sample1AbstractConditionBean implements Sample1ConditionBean {
    ...
    {
        _sqlClause = Sample1ConditionBeanContext.createSqlClause(this);
    }
     ...
     */
    abstract public Sample1ConditionQuery getConditionQueryAsInterface();
     ...
     */
    public Sample1ConditionQuery localCQ() {
    ...
    public void acceptPrimaryKeyMapString(String primaryKeyMapString) {
        ...
        Sample1MapListString mapListString = new Sample1MapListStringImpl();
     ...
     * @return this. (NotNull)
     */
    public Sample1ConditionBean limitSelect_PKOnly() {
     ...
     * @return this. (NotNull)
     */
    public Sample1ConditionBean limitSelect_Off() {
     ...
     * @return this. (NotNull)
     */
    public Sample1ConditionBean lockForUpdate() {
     ...
     * @return this. (NotNull)
     */
    public Sample1ConditionBean xsetupSelectCountIgnoreFetchScope() {
     ...
     * @return this. (NotNull)
     */
    public Sample1ConditionBean xafterCareSelectCountIgnoreFetchScope() {
    ...
    //                                                                             Specify
    //                                                                             =======
    protected static abstract class AbstractSpecification<CQ extends Sample1ConditionQuery> {
        protected Sample1ConditionBean _baseCB;
         ...
         */
        protected AbstractSpecification(Sample1ConditionBean baseCB, SpQyCall<CQ> qyCall, boolean forDeriveReferrer) {
            _baseCB = baseCB;
            _qyCall = qyCall;
    ...
    protected static interface SpQyCall<CQ extends Sample1ConditionQuery> {
        public boolean has(); 
        public CQ qy(); 
    }
    ...
    public static class RAFunction<REFERRER_CB extends Sample1ConditionBean, LOCAL_CQ extends Sample1ConditionQuery> {
        protected Sample1ConditionBean _baseCB;
        protected LOCAL_CQ _localCQ;
        protected RAQSetupper<REFERRER_CB, LOCAL_CQ> _querySetupper;
        public RAFunction(Sample1ConditionBean baseCB, LOCAL_CQ localCQ, RAQSetupper<REFERRER_CB, LOCAL_CQ> querySetupper) {
            _baseCB = baseCB;
            _localCQ = localCQ;
            _querySetupper = querySetupper;
        }
        public void max(Sample1SubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.setup("max", subQuery, _localCQ, aliasName.trim());
        }
        public void min(Sample1SubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.setup("min", subQuery, _localCQ, aliasName.trim());
        }
        public void sum(Sample1SubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.setup("sum", subQuery, _localCQ, aliasName.trim());
        }
        public void avg(Sample1SubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.setup("avg", subQuery, _localCQ, aliasName.trim());
        }
        public void count(Sample1SubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
        ...
        protected void assertAliasName(String aliasName) {
            ...
            Sample1DBMeta dbmeta = Sample1DBMetaInstanceHandler.findDBMeta(_baseCB.getTableDbName());
    ...
    public static interface RAQSetupper<REFERRER_CB extends Sample1ConditionBean, LOCAL_CQ extends Sample1ConditionQuery> {
        public void setup(String function, Sample1SubQuery<REFERRER_CB> subQuery, LOCAL_CQ cq, String aliasName);
    }
     ...
     */
    public void configure(Sample1StatementConfig statementConfig) {
    ...
    protected void assertPrimaryKeyMap(Map<String, ? extends Object> primaryKeyMap) {
        ...
        List<Sample1ColumnInfo> columnInfoList = Sample1DBMetaInstanceHandler.findDBMeta(getTableDbName()).getPrimaryUniqueInfo().getUniqueColumnList();
    ...
    public String toDisplaySql() {
        return Sample1ConditionBeanContext.convertConditionBean2DisplaySql(this);
    }
