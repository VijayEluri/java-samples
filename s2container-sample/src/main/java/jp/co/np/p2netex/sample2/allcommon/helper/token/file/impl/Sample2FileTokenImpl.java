...
import jp.co.np.p2netex.sample2.allcommon.helper.token.line.impl.Sample2LineTokenImpl;

/**
 * @author DBFlute(AutoGenerator)
 */
public class Sample2FileTokenImpl implements Sample2FileToken {

    // =====================================================================================
    //                                                                             Attribute
    //                                                                             =========
    /** Line-token for help. */
    protected final Sample2LineToken _lineToken = new Sample2LineTokenImpl();
    ...
    public void tokenize(java.io.InputStream inputStream, Sample2FileTokenizingCallback fileTokenizingCallback, Sample2FileTokenizingOption fileTokenizingOption) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        try {
            ...
            Sample2FileTokenizingHeaderInfo fileTokenizingHeaderInfo = null;
            int count = -1;
            int rowNumber = 1;
            int lineNumber = 0;
            while (true) {
                ...
                if (count == 0) {
                    if (fileTokenizingOption.isBeginFirstLine()) {
                        fileTokenizingHeaderInfo = new Sample2FileTokenizingHeaderInfo();// As empty
                    } else {
                ...
                try {
                    final Sample2FileTokenizingRowResource fileTokenizingRowResource = new Sample2FileTokenizingRowResource();
    ...
    protected ValueLineInfo arrangeValueList(final String lineString, String delimiter) {
        ...
        final Sample2LineTokenizingOption tokenizingOption = new Sample2LineTokenizingOption();
    ...
    protected Sample2FileTokenizingHeaderInfo analyzeHeaderInfo(String delimiter, final String lineString) {
        ...
        final Sample2FileTokenizingHeaderInfo fileTokenizingHeaderInfo = new Sample2FileTokenizingHeaderInfo();
    ...
    public void make(java.io.OutputStream outputStream, Sample2FileMakingCallback fileMakingCallback, Sample2FileMakingOption fileMakingOption) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        try {
            ...
            // Make header.
            final Sample2FileMakingHeaderInfo fileMakingHeaderInfo = fileMakingOption.getFileMakingHeaderInfo();
            if (fileMakingHeaderInfo != null) {
                final List<String> columnNameList = fileMakingHeaderInfo.getColumnNameList();
                if (columnNameList != null && !columnNameList.isEmpty()) {
                    final Sample2LineMakingOption lineMakingOption = new Sample2LineMakingOption();
            ...
            // Make row.
            Sample2FileMakingRowResource rowResource = null;
            while (true) {
