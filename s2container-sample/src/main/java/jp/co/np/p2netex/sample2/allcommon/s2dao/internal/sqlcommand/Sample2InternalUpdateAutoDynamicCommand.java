...
import jp.co.np.p2netex.sample2.allcommon.s2dao.internal.sqlhandler.Sample2InternalUpdateAutoHandler;

/**
 * @author DBFlute(AutoGenerator)
 */
public class Sample2InternalUpdateAutoDynamicCommand extends AbstractSqlCommand {

	// ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log instance. */
    private static final org.apache.commons.logging.Log _log = org.apache.commons.logging.LogFactory.getLog(Sample2InternalUpdateAutoDynamicCommand.class);
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample2InternalUpdateAutoDynamicCommand(DataSource dataSource, StatementFactory statementFactory) {
    ...
    public Object execute(Object[] args) {
        ...
        Sample2InternalUpdateAutoHandler handler = createInternalUpdateAutoHandler(bmd, propertyTypes);
    ...
    protected Sample2InternalUpdateAutoHandler createInternalUpdateAutoHandler(BeanMetaData bmd, PropertyType[] propertyTypes) {
        Sample2InternalUpdateAutoHandler handler = new Sample2InternalUpdateAutoHandler(getDataSource(), getStatementFactory(), bmd, propertyTypes);
    ...
    protected NotSingleRowUpdatedRuntimeException createNotSingleRowUpdatedRuntimeException(Object bean, int rows) {
        return new Sample2EntityAlreadyUpdatedException(bean, rows);
    }
