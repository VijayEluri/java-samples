...
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlhandler.Sample1InternalUpdateAutoHandler;

/**
 * @author DBFlute(AutoGenerator)
 */
public class Sample1InternalUpdateAutoDynamicCommand extends AbstractSqlCommand {

	// ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log instance. */
    private static final org.apache.commons.logging.Log _log = org.apache.commons.logging.LogFactory.getLog(Sample1InternalUpdateAutoDynamicCommand.class);
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample1InternalUpdateAutoDynamicCommand(DataSource dataSource, StatementFactory statementFactory) {
    ...
    public Object execute(Object[] args) {
        ...
        Sample1InternalUpdateAutoHandler handler = createInternalUpdateAutoHandler(bmd, propertyTypes);
    ...
    protected Sample1InternalUpdateAutoHandler createInternalUpdateAutoHandler(BeanMetaData bmd, PropertyType[] propertyTypes) {
        Sample1InternalUpdateAutoHandler handler = new Sample1InternalUpdateAutoHandler(getDataSource(), getStatementFactory(), bmd, propertyTypes);
    ...
    protected NotSingleRowUpdatedRuntimeException createNotSingleRowUpdatedRuntimeException(Object bean, int rows) {
        return new Sample1EntityAlreadyUpdatedException(bean, rows);
    }
