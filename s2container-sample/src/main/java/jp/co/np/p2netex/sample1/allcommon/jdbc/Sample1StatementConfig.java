 ...
 */
public class Sample1StatementConfig {
    ...
    //                                        ResultSet TYPE
    //                                        --------------
    public Sample1StatementConfig typeForwardOnly() {
        _resultSetType = ResultSet.TYPE_FORWARD_ONLY;
        return this;
    }
    
    public Sample1StatementConfig typeScrollInsensitive() {
        _resultSetType = ResultSet.TYPE_SCROLL_INSENSITIVE;
        return this;
    }
    
    public Sample1StatementConfig typeScrollSensitive() {
    ...
    //                                      Statement Option
    //                                      ----------------
    public Sample1StatementConfig queryTimeout(int queryTimeout) {
        this._queryTimeout = queryTimeout;
        return this;
    }
	    
    public Sample1StatementConfig fetchSize(int fetchSize) {
        this._fetchSize = fetchSize;
        return this;
    }
    
    public Sample1StatementConfig maxRows(int maxRows) {
