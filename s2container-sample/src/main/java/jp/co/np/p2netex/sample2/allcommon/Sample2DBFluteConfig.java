 ...
 */
public class Sample2DBFluteConfig {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log instance. */
    private static final org.apache.commons.logging.Log _log = org.apache.commons.logging.LogFactory.getLog(Sample2DBFluteConfig.class);
	
    /** Singleton instance. */
    private static final Sample2DBFluteConfig _instance = new Sample2DBFluteConfig();

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
	protected Sample2StatementConfig _defaultStatementConfig;
     ...
     */
    public static Sample2DBFluteConfig getInstance() {
        return _instance;
    }
    ...
    //                                                            ========================
    public Sample2StatementConfig getDefaultStatementConfig() {
        return _defaultStatementConfig;
    }
	
    public void setDefaultStatementConfig(Sample2StatementConfig defaultStatementConfig) {
	    assertNotLocked();
