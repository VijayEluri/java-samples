 ...
 */
public class Sample1SqlClauseOracle extends Sample1AbstractSqlClause {
     ...
     **/
    public Sample1SqlClauseOracle(String tableName) {
        super(tableName);
    }
    ...
    public Sample1SqlClause lockForUpdate() {
        final Sample1DBMeta dbmeta = Sample1DBMetaInstanceHandler.findDBMeta(_tableName);
        if (dbmeta.hasPrimaryKey()) {
            ...
            final String randomColumnName = ((Sample1ColumnInfo)dbmeta.getColumnInfoList().get(0)).getColumnDbName();
