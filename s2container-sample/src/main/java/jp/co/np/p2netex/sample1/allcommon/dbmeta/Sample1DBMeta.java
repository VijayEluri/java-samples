...
public interface Sample1DBMeta {
     ...
     */ 
    public Class<? extends Sample1Entity> getEntityType();
     ...
     */
    public Sample1UniqueInfo getPrimaryUniqueInfo();
     ...
     */ 
    public Sample1DBMeta findForeignDBMeta(String foreignPropName);
     ...
     */ 
    public Sample1ForeignInfo findForeignInfo(String foreignPropName);
     ...
     */
    public Sample1ColumnInfo getVersionNoColumnInfo();
     ...
     */
    public Sample1ColumnInfo getUpdateDateColumnInfo();
     ...
     */
    public String extractPrimaryKeyMapString(Sample1Entity entity);
     ...
     */
    public String extractColumnValueMapString(Sample1Entity entity);
     ...
     */
    public List<Object> convertToColumnValueList(Sample1Entity entity);
     ...
     */
    public Map<String, Object> convertToColumnValueMap(Sample1Entity entity);
     ...
     */
    public List<String> convertToColumnStringValueList(Sample1Entity entity);
     ...
     */
    public Map<String, String> convertToColumnStringValueMap(Sample1Entity entity);
     ...
     */
    public interface Eps<ENTITY_TYPE extends Sample1Entity> {
