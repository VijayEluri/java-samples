...
import jp.co.np.p2netex.sample1.allcommon.Sample1InternalMapContext;
import jp.co.np.p2netex.sample1.allcommon.Sample1BehaviorSelector;
import jp.co.np.p2netex.sample1.allcommon.annotation.OutsideSql;
...
import jp.co.np.p2netex.sample1.allcommon.exception.Sample1EntityAlreadyDeletedException;
import jp.co.np.p2netex.sample1.allcommon.exception.Sample1BatchEntityAlreadyUpdatedException;
import jp.co.np.p2netex.sample1.allcommon.exception.Sample1EntityDuplicatedException;
import jp.co.np.p2netex.sample1.allcommon.jdbc.Sample1CursorHandler;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.rshandler.Sample1InternalBeanListMetaDataResultSetHandler;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.rshandler.Sample1InternalBeanArrayMetaDataResultSetHandler;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalDeleteAutoStaticCommand;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalDeleteBatchAutoStaticCommand;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalDeleteQueryAutoDynamicCommand;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalInsertAutoDynamicCommand;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalInsertBatchAutoStaticCommand;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalProcedureCommand;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalUpdateAutoDynamicCommand;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalUpdateBatchAutoStaticCommand;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalUpdateDynamicCommand;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalUpdateModifiedOnlyCommand;
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlcommand.Sample1InternalUpdateQueryAutoDynamicCommand;
...
public class Sample1S2DaoMetaDataExtension extends DaoMetaDataImpl {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log instance. */
    private static final org.apache.commons.logging.Log _log = org.apache.commons.logging.LogFactory.getLog(Sample1S2DaoMetaDataExtension.class);
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample1S2DaoMetaDataExtension() {
    }
    ...
    protected SqlCommand initializeSpecifiedOutsideSqlCommand(String sqlCommandKey, Sample1OutsideSqlContext outsideSqlContext) throws MethodNotFoundRuntimeException {
    ...
    protected SqlCommand setupInternalNonQuerySelectMethodByDto(Method method
        ...
        Class clazz = types[0];
        // /----------------------------------------------------- [MyExtension]
        if (!Sample1ConditionBeanContext.isTheTypeConditionBean(clazz)) {
            return super.setupNonQuerySelectMethodByDto(method, handler, argNames, query);
        }
        argNames = new String[] { "dto" };
        final Sample1S2DaoSelectDynamicCommand cmd = createCustomizeSelectDynamicCommand(handler);
        cmd.setArgNames(argNames);
        cmd.setArgTypes(types);
        // -----------/
        return cmd;
    ...
    protected void setupInsertMethodByAuto(final Method method) {
        ...
        if (isUpdateSignatureForBean(method)) {
            final Sample1InternalInsertAutoDynamicCommand cmd = new Sample1InternalInsertAutoDynamicCommand();
            ...
            final Sample1InternalInsertBatchAutoStaticCommand cmd = new Sample1InternalInsertBatchAutoStaticCommand(
    ...
    protected void setupUpdateMethodByAuto(final Method method) {
        if (isFirstArgumentConditionBean(method)) {
            final SqlCommand cmd = new Sample1InternalUpdateQueryAutoDynamicCommand(dataSource, statementFactory);
            putSqlCommand(method.getName(), cmd);
            return;
        }
        checkAutoUpdateMethod(method);
    ...
    protected Sample1InternalUpdateAutoDynamicCommand createInternalUpdateAutoDynamicCommand(Method method, String[] propertyNames) {
        final Sample1InternalUpdateAutoDynamicCommand cmd = newUpdateAutoDynamicCommand(method, dataSource, statementFactory);
    ...
    protected Sample1InternalUpdateAutoDynamicCommand newUpdateAutoDynamicCommand(Method method, DataSource ds, StatementFactory sf) {
        return new Sample1InternalUpdateAutoDynamicCommand(ds, sf);
    }

    protected Sample1InternalUpdateModifiedOnlyCommand createInternalUpdateModifiedOnlyCommand(final Method method, final String[] propertyNames) {
        final Sample1InternalUpdateModifiedOnlyCommand cmd = newInternalUpdateModifiedOnlyCommand(method, dataSource, statementFactory);
        cmd.setBeanMetaData(createBeanMetaData4UpdateDeleteByAuto(method));// Extension Point!
        cmd.setPropertyNames(propertyNames);
        cmd.setCheckSingleRowUpdate(!isNonstrictMethod(method));
    ...
    protected Sample1InternalUpdateModifiedOnlyCommand newInternalUpdateModifiedOnlyCommand(Method method, DataSource ds, StatementFactory sf) {
        return new Sample1InternalUpdateModifiedOnlyCommand(ds, sf);
    }

    protected Sample1InternalUpdateBatchAutoStaticCommand createInternalUpdateBatchAutoStaticCommand(final Method method, final String[] propertyNames, boolean returningRows) {
        return new Sample1InternalUpdateBatchAutoStaticCommand(dataSource, statementFactory
    ...
    protected void setupDeleteMethodByAuto(final Method method) {
        if (isFirstArgumentConditionBean(method)) {
            final SqlCommand cmd = new Sample1InternalDeleteQueryAutoDynamicCommand(dataSource, statementFactory);
            putSqlCommand(method.getName(), cmd);
            return;
        }
        checkAutoUpdateMethod(method);
    ...
    protected Sample1InternalDeleteAutoStaticCommand createInternalDeleteAutoStaticCommand(final Method method, final String[] propertyNames) {
        final Sample1InternalDeleteAutoStaticCommand cmd = new Sample1InternalDeleteAutoStaticCommand(dataSource, statementFactory, createBeanMetaData4UpdateDeleteByAuto(method), propertyNames);
        cmd.setCheckSingleRowUpdate(!isNonstrictMethod(method));
        return cmd;
    }

    protected Sample1InternalDeleteBatchAutoStaticCommand createInternalDeleteBatchAutoStaticCommand(final Method method, final String[] propertyNames, boolean returningRows) {
        return new Sample1InternalDeleteBatchAutoStaticCommand(dataSource, statementFactory, createBeanMetaData4UpdateDeleteByAuto(method), propertyNames, returningRows) {
            @Override
    ...
    protected BeanMetaDataFactory createNonConcurrencyBmdFactory() {
        final Sample1S2BeanMetaDataFactoryImpl nonConcurrencyBmdFactory = new Sample1S2BeanMetaDataFactoryImpl() {
    ...
    protected boolean isFirstArgumentConditionBean(final Method method) {
        ...
        return pmbTypes.length > 0 && Sample1ConditionBean.class.isAssignableFrom(pmbTypes[0]);
    }
    ...
    protected void handleBatchUpdateResultWithOptimisticLock(PreparedStatement ps, List<?> list, int[] result, Method method) throws SQLException {
        if (Sample1ConditionBeanContext.isOracle()) {
    ...
    protected void handleBatchUpdateResultWithOptimisticLockByUpdateCount(List<?> list, int updateCount, Method method) {
        ...
        if (updateCount < entityCount) {
            if (isNonstrictMethod(method)) {
                ...
                throw new Sample1EntityAlreadyDeletedException(msg);
            } else {
                throw new Sample1BatchEntityAlreadyUpdatedException(list.get(0), 0, updateCount);
            }
        }
    }
    ...
    protected void handleBatchUpdateResultWithOptimisticLockByResult(List<?> list, Object result, Method method) {
        ...
        for (int oneUpdateCount : updatedCountArray) {
            ...
            if (oneUpdateCount == 0) {
                ...
                msg = msg + " allEntities=" + list;
                throw new Sample1EntityDuplicatedException(msg);
            }
            ++index;
        }
        if (alreadyUpdated) {
            ...
            if (isNonstrictMethod(method)) {
                ...
                throw new Sample1BatchEntityAlreadyUpdatedException(list.get(index), 0, updateCount);
            }
        }
    }
    ...
    protected void setupSelectMethodByManual(Method method, String sql) {// Contains SQL-Annotation
        ...
        if (pmbTypes != null && pmbTypes.length > 0
                && Sample1CursorHandler.class.isAssignableFrom(pmbTypes[pmbTypes.length-1])) {
    ...
    //     final Sample1InternalUpdateDynamicCommand cmd = new Sample1InternalUpdateDynamicCommand(dataSource, statementFactory);
    //     cmd.setSql(sql);
    ...
    //                  Select
    //                   - - -
    protected void setupSpecifiedOutsideSqlSelectCommand(String sqlCommandKey, Method method, Sample1OutsideSqlContext outsideSqlContext) {
        // - - - - - - - - - - - - - - - - - - - - - - -
        ...
        } else if (Sample1CursorHandler.class.isAssignableFrom(lastestArguementType)) {
            // - - - - - - - -
            // CursorHandling
            // - - - - - - - -
...
//    }
    ...
    protected ResultSetHandler createSpecifiedOutsideSqlCustomizeBeanListResultSetHandler(BeanMetaData specifiedBeanMetaData, Class<?> customizeEntityType) {
        ...
        return new Sample1InternalBeanListMetaDataResultSetHandler(specifiedBeanMetaData, new RowCreatorExtension(), new RelationRowCreatorExtension());
    }
    ...
    //                 Execute
    //                 - - - -
    protected void setupSpecifiedOutsideSqlExecuteCommand(String sqlCommandKey, Method method, Sample1OutsideSqlContext outsideSqlContext) {
        // - - - - - - - - - - - - - - - - - - - - - - -
        // The attribute of Specified-OutsideSqlContext.
        // - - - - - - - - - - - - - - - - - - - - - - -
        final String sql = outsideSqlContext.readFilteredOutsideSql(getSqlFileEncoding(), dbms.getSuffix());
    ...
    //          Call Procedure
    //           - - - - - - -
    protected void setupSpecifiedOutsideSqlCallCommand(String sqlCommandKey, Method method, Sample1OutsideSqlContext outsideSqlContext) {
        // - - - - - - - - - - - - - - - - - - - - - - -
        // The attribute of Specified-OutsideSqlContext.
        // - - - - - - - - - - - - - - - - - - - - - - -
        final Object pmb = outsideSqlContext.getParameterBean();
        ...
        final Sample1InternalProcedureCommand cmd = createInternalProcedureCommand(method, metaData);
        putSqlCommand(sqlCommandKey, cmd);
    }

    protected Sample1InternalProcedureCommand createInternalProcedureCommand(Method method, ProcedureMetaData metaData) {
        final ResultSetHandler resultSetHandler = createResultSetHandler(method);
        return new Sample1InternalProcedureCommand(dataSource, resultSetHandler, statementFactory, resultSetFactory, metaData);
    }
    ...
    protected BeanMetaDataFactory createOutsideSqlCustomizeBeanMetaDataFactory() {
        final Sample1S2BeanMetaDataFactoryImpl originalBmdFactory = new Sample1S2BeanMetaDataFactoryImpl() {
            protected BeanMetaDataImpl createBeanMetaDataImpl() {
    ...
    protected static class OutsideSqlPropertyTypeFactoryBuilderExtension extends PropertyTypeFactoryBuilderImpl {
        ...
        public PropertyTypeFactory build(Class beanClass, BeanAnnotationReader beanAnnotationReader, Dbms dbms, DatabaseMetaData databaseMetaData) {
            return new Sample1S2DaoPropertyTypeFactoryBuilderExtension.FastPropertyTypeFactoryExtension(beanClass, beanAnnotationReader, valueTypeFactory, columnNaming, daoNamingConvention, dbms);
        }
    }
    ...
    protected void registerSqlCommand(String sqlCommandKey, Method method, String sql, String[] argNames, Class[] argTypes, ResultSetHandler myResultSetHandler) {
        final Sample1S2DaoSelectDynamicCommand cmd = createCustomizeSelectDynamicCommand(myResultSetHandler);
        registerSqlCommand(sqlCommandKey, method, sql, argNames, argTypes, cmd);
    }

    protected void registerSqlCommand(String sqlCommandKey, Method method, String sql, String[] argNames, Class[] argTypes, Sample1S2DaoSelectDynamicCommand cmd) {
        cmd.setSql(sql);
        cmd.setArgNames(argNames);
    ...
    protected void registerSqlCommand(String sqlCommandKey, Method method, String sql, String[] argNames, Class[] argTypes, Sample1InternalUpdateDynamicCommand cmd) {
        cmd.setSql(sql);
        cmd.setArgNames(argNames);
        cmd.setArgTypes(argTypes);
        this.sqlCommands.put(sqlCommandKey, cmd);
     ...
     */
    protected Sample1S2DaoSelectDynamicCommand createCustomizeSelectDynamicCommand(ResultSetHandler handler) {
        return new Sample1S2DaoSelectDynamicCommand(dataSource, statementFactory, handler, resultSetFactory);
    }
    ...
    public static class ResultSetHandlerFactoryExtension extends ResultSetHandlerFactoryImpl {
        ...
        protected ResultSetHandler createBeanListMetaDataResultSetHandler(BeanMetaData beanMetaData) {
            return new Sample1InternalBeanListMetaDataResultSetHandler(beanMetaData, createRowCreator(), createRelationRowCreator());
        }
        
        @Override
        protected ResultSetHandler createBeanArrayMetaDataResultSetHandler(BeanMetaData beanMetaData) {
            return new Sample1InternalBeanArrayMetaDataResultSetHandler(beanMetaData, createRowCreator(), createRelationRowCreator());
        }
    }
    ...
    protected static class RowCreatorExtension extends org.seasar.dao.impl.RowCreatorImpl {
        ...
        public Object createRow(ResultSet rs, Map propertyCache, Class beanClass) throws SQLException  {
            ...
            final Sample1DBMeta dbmeta = findDBMeta(row);
         ...
         */
        protected Sample1DBMeta findDBMeta(Object row) {
            return EntityPropertySetupperHandler.findCachedDBMeta(row);
        }

        protected void throwNonsenseClassCastException(Object entity, Sample1DBMeta dbmeta, ClassCastException e) {
    ...
    protected static class EntityPropertySetupperHandler {
        ...
        public static Sample1DBMeta findCachedDBMeta(Object row) {
            if (!(row instanceof Sample1Entity)) {
                return null;
            }
            final Sample1Entity entity = (Sample1Entity) row;
            Map<Class<?>, Sample1DBMeta> dbmetaCache = (Map<Class<?>, Sample1DBMeta>)Sample1InternalMapContext.getObject(DBMETA_CACHE_KEY);
            if (dbmetaCache == null) {
                dbmetaCache = new HashMap<Class<?>, Sample1DBMeta>();
                Sample1InternalMapContext.setObject(DBMETA_CACHE_KEY, dbmetaCache);
            }
            Sample1DBMeta dbmeta = dbmetaCache.get(entity.getClass());
            if (dbmeta != null) {
                return dbmeta;
            }
    ...
    protected static class RelationRowCreatorExtension extends org.seasar.dao.impl.RelationRowCreatorImpl {
        ...
        protected void registerRelationValue(RelationRowCreationResource res, String columnName) throws SQLException {
            ...
            if (value != null) {
                ...
                final Sample1DBMeta dbmeta = findDBMeta(res.getRow());
        ...
        protected boolean hasConditionBean(RelationRowCreationResource res) {
            return Sample1ConditionBeanContext.isExistConditionBeanOnThread();
        }
    }
    ...
    protected static class InternalProcedureMetaDataFactory {
        ...
        protected ValueType getValueType(final BeanDesc dtoDesc, final Field field) {
            ...
            if (List.class.isAssignableFrom(type)) {// is for out parameter cursor.
                ...
                } else if (Sample1ConditionBeanContext.isPostgreSql()) {
    ...
    //                                     DBFlute Extension
    //                                     -----------------
    public Sample1BehaviorSelector getBehaviorSelector() {
        return _behaviorSelector;
    }

    public void setBehaviorSelector(final Sample1BehaviorSelector behaviorSelector) {
