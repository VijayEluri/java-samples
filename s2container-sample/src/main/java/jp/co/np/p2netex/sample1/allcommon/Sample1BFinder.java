...
public class Sample1BFinder {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    protected static String _dbfluteDiconName = "dbflute-sample1.dicon";

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    private Sample1BFinder() {
    }

    // ===================================================================================
    //                                                                              Finder
    //                                                                             ======
    public static <BEHAVIOR_TYPE extends Sample1BehaviorReadable> BEHAVIOR_TYPE find(Class<BEHAVIOR_TYPE> behaviorType) {
        ...
        if (!org.seasar.framework.container.factory.SingletonS2ContainerFactory.hasContainer()) {
            synchronized (Sample1BFinder.class) {
                if (!org.seasar.framework.container.factory.SingletonS2ContainerFactory.hasContainer()) {
