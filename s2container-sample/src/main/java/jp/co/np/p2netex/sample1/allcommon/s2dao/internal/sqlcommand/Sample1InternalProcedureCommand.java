...
import jp.co.np.p2netex.sample1.allcommon.s2dao.internal.sqlhandler.Sample1InternalProcedureHandler;

/**
 * @author DBFlute(AutoGenerator)
 */
public class Sample1InternalProcedureCommand implements SqlCommand {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample1InternalProcedureCommand(DataSource dataSource, ResultSetHandler resultSetHandler,
    ...
    public Object execute(final Object[] args) {
        final Sample1InternalProcedureHandler handler = newArgumentDtoProcedureHandler();
    ...
    protected Sample1InternalProcedureHandler newArgumentDtoProcedureHandler() {
        return new Sample1InternalProcedureHandler(dataSource, createSql(procedureMetaData), resultSetHandler,
