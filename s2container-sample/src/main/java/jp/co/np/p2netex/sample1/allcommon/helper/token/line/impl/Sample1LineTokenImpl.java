package jp.co.np.p2netex.sample1.allcommon.helper.token.line.impl;
 ...
 */
public class Sample1LineTokenImpl implements Sample1LineToken {

    public List<String> tokenize(String lineString, Sample1LineTokenizingOption lineTokenizingOption) {
    ...
    protected String filterHandlingEmptyAsNull(String target, Sample1LineTokenizingOption lineTokenizingOption) {
        if (target == null) {
            return null;
        }
