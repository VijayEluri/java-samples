package jp.co.np.p2netex.sample2.allcommon.helper.collection.order.impl;
...
import jp.co.np.p2netex.sample2.allcommon.helper.collection.order.Sample2AccordingToOrder;
import jp.co.np.p2netex.sample2.allcommon.helper.collection.order.Sample2AccordingToOrderIdExtractor;
import jp.co.np.p2netex.sample2.allcommon.helper.collection.order.Sample2AccordingToOrderOption;

/**
 * @author DBFlute(AutoGenerator)
 */
public class Sample2AccordingToOrderImpl implements Sample2AccordingToOrder {
     ...
     */
    public <ELEMENT_TYPE, ID_TYPE> void order(final List<ELEMENT_TYPE> unorderedList, final Sample2AccordingToOrderOption<ELEMENT_TYPE, ID_TYPE> option) {
        ...
        final Sample2AccordingToOrderIdExtractor<ELEMENT_TYPE, ID_TYPE> idExtractor = option.getIdExtractor();
