...
import jp.co.np.p2netex.sample2.allcommon.s2dao.internal.sqlhandler.Sample2InternalInsertAutoHandler;

/**
 * @author DBFlute(AutoGenerator)
 */
public class Sample2InternalInsertAutoDynamicCommand implements SqlCommand {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public Sample2InternalInsertAutoDynamicCommand() {
    }
    ...
    public Object execute(Object[] args) {
        ...
        final Sample2InternalInsertAutoHandler handler = new Sample2InternalInsertAutoHandler(getDataSource(), getStatementFactory(), bmd, propertyTypes);
        handler.setSql(sql);
