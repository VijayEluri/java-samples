 ...
 */
public class Sample2InternalSqlLogRegistry {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log instance. */
    private static final org.apache.commons.logging.Log _log = org.apache.commons.logging.LogFactory.getLog(Sample2InternalSqlLogRegistry.class);
	...
	public static Object findContainerSqlLogRegistry() {
	    ...
	    try {
		    ...
		    String msg = "Sample2InternalSqlLogRegistry.findContainerSqlLogRegistry() threw the exception:";
	...
	public static void closeRegistration() {
	    ...
	    try {
		    ...
		    String msg = "Sample2InternalSqlLogRegistry.closeRegistration() threw the exception:";
			msg = msg + " sqlLogRegistryLocatorType=" + sqlLogRegistryLocatorType;
	...
	protected static Object createContainerSqlLogImpl(String rawSql, String completeSql, Object[] bindArgs, Class<?>[] bindArgTypes) {
	    try {
		    ...
		    String msg = "Sample2InternalSqlLogRegistry.createContainerSqlLogImpl() threw the exception:";
	...
	protected static void reflectSqlLogToContainerSqlLogRegistry(Object sqlLog, Object sqlLogRegistry) {
	    ...
	    try {
		    ...
		    String msg = "Sample2InternalSqlLogRegistry.reflectToContainerSqlLogRegistry() threw the exception:";
	...
	protected static Object findLastContainerSqlLog(Object sqlLogRegistry) {
	    ...
	    try {
		    ...
		    String msg = "Sample2InternalSqlLogRegistry.findLastContainerSqlLog() threw the exception:";
	...
	protected static String extractCompleteSqlFromContainerSqlLog(Object sqlLog) {
	    ...
	    try {
		    ...
		    String msg = "Sample2InternalSqlLogRegistry.extractCompleteSqlFromContainerSqlLog() threw the exception:";
