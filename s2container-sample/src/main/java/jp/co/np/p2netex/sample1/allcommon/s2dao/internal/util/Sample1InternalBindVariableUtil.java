package jp.co.np.p2netex.sample1.allcommon.s2dao.internal.util;
 ...
 */
public class Sample1InternalBindVariableUtil {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    private Sample1InternalBindVariableUtil() {
    }
    ...
    protected static String getLogDateFormat() {
        String logDateFormat = Sample1DBFluteConfig.getInstance().getLogDateFormat();
        return logDateFormat != null ? logDateFormat : "yyyy-MM-dd";
    }

    protected static String getLogTimestampFormat() {
        String logTimestampFormat = Sample1DBFluteConfig.getInstance().getLogTimestampFormat();
