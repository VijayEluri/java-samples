 ...
 */
public class OtherDBFluteConfig {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log instance. */
    private static final Log _log = LogFactory.getLog(OtherDBFluteConfig.class);
    ...
    /** Singleton instance. */
    private static final OtherDBFluteConfig _instance = new OtherDBFluteConfig();
     ...
     * Constructor.
     */
    private OtherDBFluteConfig() { // adjusts default settings
     ...
     */
    public static OtherDBFluteConfig getInstance() {
        return _instance;
    }
    ...
    public static class ImplementedOracleAgent implements OracleAgent {
        ...
        public PhysicalConnectionDigger getPhysicalConnectionDigger() {
            return OtherDBFluteConfig.getInstance().getPhysicalConnectionDigger();
        }
    }
