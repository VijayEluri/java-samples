...
/**
 * The abstract condition-query of users2.
 * @author DBFlute(AutoGenerator)
 */
public abstract class OtherAbstractBsUsers2CQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public OtherAbstractBsUsers2CQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;OtherUsers2CB&gt;() {
     *     public void query(OtherUsers2CB subCB) {
     ...
     */
    public HpSSQFunction<OtherUsers2CB> scalar_Equal() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;OtherUsers2CB&gt;() {
     *     public void query(OtherUsers2CB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<OtherUsers2CB> scalar_NotEqual() {
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;OtherUsers2CB&gt;() {
     *     public void query(OtherUsers2CB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<OtherUsers2CB> scalar_GreaterThan() {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;OtherUsers2CB&gt;() {
     *     public void query(OtherUsers2CB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<OtherUsers2CB> scalar_LessThan() {
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;OtherUsers2CB&gt;() {
     *     public void query(OtherUsers2CB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<OtherUsers2CB> scalar_GreaterEqual() {
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;OtherUsers2CB&gt;() {
     *     public void query(OtherUsers2CB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<OtherUsers2CB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand());
    }

    protected HpSSQFunction<OtherUsers2CB> xcreateSSQFunction(final String operand) {
        return new HpSSQFunction<OtherUsers2CB>(new HpSSQSetupper<OtherUsers2CB>() {
            public void setup(String function, SubQuery<OtherUsers2CB> subQuery, HpSSQOption<OtherUsers2CB> option) {
                xscalarCondition(function, subQuery, operand, option);
            }
        });
    }

    protected void xscalarCondition(String function, SubQuery<OtherUsers2CB> subQuery, String operand, HpSSQOption<OtherUsers2CB> option) {
        assertObjectNotNull("subQuery<OtherUsers2CB>", subQuery);
        OtherUsers2CB cb = xcreateScalarConditionCB(); subQuery.query(cb);
        String subQueryPropertyName = keepScalarCondition(cb.query()); // for saving query-value
        option.setPartitionByCBean(xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(function, cb.query(), subQueryPropertyName, operand, option);
    }
    public abstract String keepScalarCondition(OtherUsers2CQ subQuery);

    protected OtherUsers2CB xcreateScalarConditionCB() {
        OtherUsers2CB cb = new OtherUsers2CB();
        cb.xsetupForScalarCondition(this);
        return cb;
    }

    protected OtherUsers2CB xcreateScalarConditionPartitionByCB() {
        OtherUsers2CB cb = new OtherUsers2CB();
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String function, SubQuery<OtherUsers2CB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<OtherUsers2CB>", subQuery);
        OtherUsers2CB cb = new OtherUsers2CB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepSpecifyMyselfDerived(cb.query()); // for saving query-value.
        registerSpecifyMyselfDerived(function, cb.query(), "id", "id", subQueryPropertyName, "myselfDerived", aliasName, option);
    }
    public abstract String keepSpecifyMyselfDerived(OtherUsers2CQ subQuery);

    /**
     * Prepare for (Query)MyselfDerived (SubQuery).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<OtherUsers2CB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived();
    }
    protected HpQDRFunction<OtherUsers2CB> xcreateQDRFunctionMyselfDerived() {
        return new HpQDRFunction<OtherUsers2CB>(new HpQDRSetupper<OtherUsers2CB>() {
            public void setup(String function, SubQuery<OtherUsers2CB> subQuery, String operand, Object value, DerivedReferrerOption option) {
                xqderiveMyselfDerived(function, subQuery, operand, value, option);
            }
        });
    }
    public void xqderiveMyselfDerived(String function, SubQuery<OtherUsers2CB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<OtherUsers2CB>", subQuery);
        OtherUsers2CB cb = new OtherUsers2CB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
    ...
    public abstract String keepQueryMyselfDerived(OtherUsers2CQ subQuery);
     ...
     */
    public void myselfExists(SubQuery<OtherUsers2CB> subQuery) {
        assertObjectNotNull("subQuery<OtherUsers2CB>", subQuery);
        OtherUsers2CB cb = new OtherUsers2CB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfExists(cb.query()); // for saving query-value.
        registerMyselfExists(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfExists(OtherUsers2CQ subQuery);
     ...
     * @param subQuery The implementation of sub query. (NotNull)
     */
    public void myselfInScope(SubQuery<OtherUsers2CB> subQuery) {
        assertObjectNotNull("subQuery<OtherUsers2CB>", subQuery);
        OtherUsers2CB cb = new OtherUsers2CB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfInScope(cb.query()); // for saving query-value.
        registerMyselfInScope(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfInScope(OtherUsers2CQ subQuery);

    // ===================================================================================
    //                                                                       Very Internal
    //                                                                       =============
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabCB() { return OtherUsers2CB.class.getName(); }
    protected String xabCQ() { return OtherUsers2CQ.class.getName(); }
