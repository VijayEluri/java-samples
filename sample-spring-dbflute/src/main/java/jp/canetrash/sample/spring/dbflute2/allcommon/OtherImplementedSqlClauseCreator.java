 ...
 */
public class OtherImplementedSqlClauseCreator implements SqlClauseCreator {
    ...
    protected boolean isInnerJoinAutoDetect() {
	    return OtherDBFluteConfig.getInstance().isInnerJoinAutoDetect();
    }

    protected boolean isEmptyStringQueryAllowed() {
	    return OtherDBFluteConfig.getInstance().isEmptyStringQueryAllowed();
    }

    protected boolean isInvalidQueryChecked() {
	    return OtherDBFluteConfig.getInstance().isInvalidQueryChecked();
    }

    protected boolean isDisableSelectIndex() {
	    return OtherDBFluteConfig.getInstance().isDisableSelectIndex();
    }
}
