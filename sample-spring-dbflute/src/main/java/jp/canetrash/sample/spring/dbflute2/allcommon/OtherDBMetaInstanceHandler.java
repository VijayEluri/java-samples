 ...
 */
public class OtherDBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("users2", "jp.canetrash.sample.spring.dbflute2.bsentity.dbmeta.OtherUsers2Dbm");
    ...
    //                                                                  Provider Singleton
    //                                                                  ==================
    protected static final DBMetaProvider _provider = new OtherDBMetaInstanceHandler();
    ...
    protected static DBMeta byTableFlexibleName(String tableFlexibleName) {
        ...
        if (schema != null) { // at first, find by qualified name
            tableDbName = _tableDbNameFlexibleMap.get(schema + "." + pureName);
        }
        if (tableDbName == null) { // and next, find by pure name
