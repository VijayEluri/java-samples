 ...
 */
public class OtherImplementedBehaviorSelector implements BehaviorSelector {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** Log instance. */
    private static final Log _log = LogFactory.getLog(OtherImplementedBehaviorSelector.class);
    ...
    public void initializeConditionBeanMetaData() {
        final Map<String, DBMeta> dbmetaMap = OtherDBMetaInstanceHandler.getUnmodifiableDBMetaMap();
    ...
    public BehaviorReadable byName(String tableFlexibleName) {
        ...
        final DBMeta dbmeta = OtherDBMetaInstanceHandler.findDBMeta(tableFlexibleName);
