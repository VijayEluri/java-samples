package jp.canetrash.sample.spring.dbflute2.bsentity;
...
import jp.canetrash.sample.spring.dbflute2.allcommon.OtherDBMetaInstanceHandler;
import jp.canetrash.sample.spring.dbflute2.exentity.*;

/**
 * The entity of users2 as TABLE. <br />
 * <pre>
 * [primary-key]
 *     id
 * 
 ...
 */
public abstract class OtherBsUsers2 implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return OtherDBMetaInstanceHandler.findDBMeta(getTableDbName());
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof OtherBsUsers2)) { return false; }
        OtherBsUsers2 otherEntity = (OtherBsUsers2)other;
     ...
     */
    public OtherUsers2 clone() {
        try {
            return (OtherUsers2)super.clone();
