...
import org.apache.maven.plugin.eclipse.writers.EclipseClasspathWriter2;
...
import org.apache.maven.plugin.eclipse.writers.EclipseMetadataWriter;
import org.apache.maven.plugin.eclipse.writers.EclipseTomcatPluginWriter;
 ...
 * @version $Id: EclipsePlugin.java 371287 2006-01-22 13:30:12Z fgiust $
 * @goal eclipse
...
public class EclipsePlugin
    ...
    /**
     * @parameter expression="${outputSettings}" default-value="false"
     * @required
     */
    private boolean outputSettings = false;

    /**
     * @parameter expression="${tomcatPluginSettings}"
     */
    private TomcatPluginSettings tomcatPluginSettings = new TomcatPluginSettings();

    /**
     * @parameter expression="${tomcatPluginProjectSettings}"
     */
    private TomcatPluginProjectSettings tomcatPluginProjectSettings = new TomcatPluginProjectSettings();

    /**
     * @parameter expression="${teamCoreSettings}"
     */
    private TeamCoreSettings teamCoreSettings = new TeamCoreSettings();
    ...
    public void write()
        ...
        new EclipseClasspathWriter2(getLog(), eclipseProjectDir, project, artifacts).write(projectBaseDir,
                reactorArtifacts,
                sourceDirs,
                classpathContainers,
                localRepository,
        ...
        paramMap.put("TomcatPluginProjectPrefs", tomcatPluginProjectSettings);
        paramMap.put("TeamCorePrefs", teamCoreSettings);
        new EclipseMetadataWriter(getLog(), eclipseProjectDir, project).write(paramMap);

        if (tomcatPluginSettings.getEnabled()) {
            new EclipseTomcatPluginWriter(getLog(), eclipseProjectDir, project).write(tomcatPluginSettings, projectBaseDir, reactorArtifacts, localRepository, buildOutputDirectory);
        }
    ...
    public boolean isOutputSettings() {
        return outputSettings;
    }

    public void setOutputSettings(boolean outputSettings) {
        this.outputSettings = outputSettings;
    }

    public TomcatPluginSettings getTomcatPluginSettings() {
        return tomcatPluginSettings;
    }

    public void setTomcatPluginSettings(TomcatPluginSettings tomcatPluginSettings) {
        this.tomcatPluginSettings = tomcatPluginSettings;
    }
